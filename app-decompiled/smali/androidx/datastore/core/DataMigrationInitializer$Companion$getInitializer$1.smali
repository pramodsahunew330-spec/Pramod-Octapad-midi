...
.method public final invoke(Landroidx/datastore/core/InitializerApi;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;
    ...
    .local v1, "this":Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;->L$0:Ljava/lang/Object;

    check-cast v2, Landroidx/datastore/core/InitializerApi;

    .line 33
    .local v2, "api":Landroidx/datastore/core/InitializerApi;
    sget-object v3, Landroidx/datastore/core/DataMigrationInitializer;->Companion:Landroidx/datastore/core/DataMigrationInitializer$Companion;

    iget-object v4, v1, Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;->$migrations:Ljava/util/List;
    ...
    iput v6, v1, Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;->label:I

    invoke-static {v3, v4, v2, v5}, Landroidx/datastore/core/DataMigrationInitializer$Companion;->access$runMigrations(Landroidx/datastore/core/DataMigrationInitializer$Companion;Ljava/util/List;Landroidx/datastore/core/InitializerApi;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v2

    .end local v2    # "api":Landroidx/datastore/core/InitializerApi;
    if-ne v2, v0, :cond_0
    ...
    .line 34
    .end local v1    # "this":Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;
    .restart local v0    # "this":Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
