...
.method public static final rotationMatrix(FFF)Landroid/graphics/Matrix;
    ...
    .line 55
    .local v1, "$this$rotationMatrix_u24lambda_u244":Landroid/graphics/Matrix;
    const/4 v2, 0x0
    ...
    .end local v1    # "$this$rotationMatrix_u24lambda_u244":Landroid/graphics/Matrix;
...
.method public static final scaleMatrix(FF)Landroid/graphics/Matrix;
    ...
    .line 55
    .local v1, "$this$scaleMatrix_u24lambda_u243":Landroid/graphics/Matrix;
    const/4 v2, 0x0
    ...
    .end local v1    # "$this$scaleMatrix_u24lambda_u243":Landroid/graphics/Matrix;
...
.method public static final times(Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/graphics/Matrix;
    ...
    .line 55
    .local v2, "$this$times_u24lambda_u240":Landroid/graphics/Matrix;
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$times_u24lambda_u240":Landroid/graphics/Matrix;
...
.method public static final translationMatrix(FF)Landroid/graphics/Matrix;
    ...
    .line 55
    .local v1, "$this$translationMatrix_u24lambda_u242":Landroid/graphics/Matrix;
    const/4 v2, 0x0
    ...
    .end local v1    # "$this$translationMatrix_u24lambda_u242":Landroid/graphics/Matrix;
...
.method public static final values(Landroid/graphics/Matrix;)[F
    ...
    .line 55
    .local v2, "$this$values_u24lambda_u241":[F
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$values_u24lambda_u241":[F
