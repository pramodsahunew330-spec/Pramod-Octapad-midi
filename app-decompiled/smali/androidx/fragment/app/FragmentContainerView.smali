...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v3, p2, v2, v4, v5}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v7

    move-object v8, v7

    .local v8, "$this$_init__u24lambda_u240":Landroid/content/res/TypedArray;
    const/4 v9, 0x0

    .line 114
    .local v9, "$i$a$-withStyledAttributes$default-FragmentContainerView$1":I
    if-nez v0, :cond_0

    .line 115
    sget v10, Landroidx/fragment/R$styleable;->FragmentContainerView_android_name:I
    ...
    .line 353
    .end local v8    # "$this$_init__u24lambda_u240":Landroid/content/res/TypedArray;
    .end local v9    # "$i$a$-withStyledAttributes$default-FragmentContainerView$1":I
    ...
    const-string v4, "FragmentContainerView must be within a FragmentActivity to use "
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Landroidx/fragment/app/FragmentManager;)V
    ...
    invoke-virtual {v4, p2, v3, v5, v6}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v8

    move-object v9, v8

    .local v9, "$this$_init__u24lambda_u241":Landroid/content/res/TypedArray;
    const/4 v10, 0x0

    .line 136
    .local v10, "$i$a$-withStyledAttributes$default-FragmentContainerView$2":I
    if-nez v1, :cond_0

    .line 137
    sget v11, Landroidx/fragment/R$styleable;->FragmentContainerView_android_name:I
    ...
    .line 139
    :cond_0
    sget v11, Landroidx/fragment/R$styleable;->FragmentContainerView_android_tag:I
    ...
    .line 359
    .end local v9    # "$this$_init__u24lambda_u241":Landroid/content/res/TypedArray;
    .end local v10    # "$i$a$-withStyledAttributes$default-FragmentContainerView$2":I
    ...
    .end local v7    # "$i$f$withStyledAttributes":I
    ...
    invoke-virtual {v5, v6, v1}, Landroidx/fragment/app/FragmentFactory;->instantiate(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroidx/fragment/app/Fragment;

    move-result-object v5

    const-string v6, "fm.fragmentFactory.insta\u2026ontext.classLoader, name)"
    ...
    .line 154
    .local v5, "containerFragment":Landroidx/fragment/app/Fragment;
    const/4 v6, 0x0

    invoke-virtual {v5, p1, p2, v6}, Landroidx/fragment/app/Fragment;->onInflate(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/os/Bundle;)V
    ...
    .line 156
    invoke-virtual {v6, v0}, Landroidx/fragment/app/FragmentTransaction;->setReorderingAllowed(Z)Landroidx/fragment/app/FragmentTransaction;
    ...
    invoke-virtual {v0, v6, v5, v2}, Landroidx/fragment/app/FragmentTransaction;->add(Landroid/view/ViewGroup;Landroidx/fragment/app/Fragment;Ljava/lang/String;)Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 160
    .end local v5    # "containerFragment":Landroidx/fragment/app/Fragment;
    :cond_3
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 268
    .local v0, "$i$a$-checkNotNull-FragmentContainerView$addView$1":I
    ...
    .line 266
    .end local v0    # "$i$a$-checkNotNull-FragmentContainerView$addView$1":I
...
.method public dispatchApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-virtual {v1, v2, v3, p1}, Landroidx/fragment/app/FragmentContainerView$Api20Impl;->onApplyWindowInsets(Landroid/view/View$OnApplyWindowInsetsListener;Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    .line 204
    :goto_0
    const-string v2, "if (applyWindowInsetsLis\u2026, insetsCompat)\n        }"
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    .line 222
    .local v5, "$i$a$-forEach-FragmentContainerView$dispatchDraw$1":I
    invoke-virtual {p0}, Landroidx/fragment/app/FragmentContainerView;->getDrawingTime()J

    move-result-wide v6

    invoke-super {p0, p1, v4, v6, v7}, Landroid/widget/FrameLayout;->drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .end local v5    # "$i$a$-forEach-FragmentContainerView$dispatchDraw$1":I
    nop
