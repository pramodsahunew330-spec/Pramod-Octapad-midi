...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 250
    .local v13, "itemRippleColor":Landroid/content/res/ColorStateList;
    if-eqz v13, :cond_d

    .line 251
    const/4 v14, 0x0

    invoke-direct {v0, v1, v14}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(Landroidx/appcompat/widget/TintTypedArray;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;

    move-result-object v15

    .line 252
    .local v15, "itemRippleMask":Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v9, v10, v14, v15}, Landroid/graphics/drawable/RippleDrawable;-><init>(Landroid/content/res/ColorStateList;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v10, v9}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setItemForeground(Landroid/graphics/drawable/RippleDrawable;)V

    .line 260
    .end local v9    # "ripple":Landroid/graphics/drawable/RippleDrawable;
    .end local v13    # "itemRippleColor":Landroid/content/res/ColorStateList;
    .end local v15    # "itemRippleMask":Landroid/graphics/drawable/Drawable;
    :cond_d
    ...
    invoke-virtual {v1, v9, v10}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result v9

    .line 263
    .local v9, "itemHorizontalPadding":I
    invoke-virtual {v0, v9}, Lcom/google/android/material/navigation/NavigationView;->setItemHorizontalPadding(I)V

    .line 266
    .end local v9    # "itemHorizontalPadding":I
    :cond_e
    sget v9, Lcom/google/android/material/R$styleable;->NavigationView_itemVerticalPadding:I
    ...
    .line 269
    .local v9, "itemVerticalPadding":I
    invoke-virtual {v0, v9}, Lcom/google/android/material/navigation/NavigationView;->setItemVerticalPadding(I)V

    goto :goto_1

    .line 266
    .end local v9    # "itemVerticalPadding":I
    :cond_f
    const/4 v10, 0x0

    .line 272
    :goto_1
    sget v9, Lcom/google/android/material/R$styleable;->NavigationView_dividerInsetStart:I
    ...
    .line 274
    .local v9, "dividerInsetStart":I
    invoke-virtual {v0, v9}, Lcom/google/android/material/navigation/NavigationView;->setDividerInsetStart(I)V

    .line 276
    sget v13, Lcom/google/android/material/R$styleable;->NavigationView_dividerInsetEnd:I

    .line 277
    invoke-virtual {v1, v13, v10}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result v13

    .line 278
    .local v13, "dividerInsetEnd":I
    ...
    .line 285
    invoke-virtual {v1, v15, v10}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    .line 288
    sget v10, Lcom/google/android/material/R$styleable;->NavigationView_topInsetScrimEnabled:I

    iget-boolean v7, v0, Lcom/google/android/material/navigation/NavigationView;->topInsetScrimEnabled:Z

    .line 289
    invoke-virtual {v1, v10, v7}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    iget-boolean v10, v0, Lcom/google/android/material/navigation/NavigationView;->bottomInsetScrimEnabled:Z
    ...
    invoke-virtual {v1, v7, v10}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v8, v11, v10}, Lcom/google/android/material/internal/NavigationMenuPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {v8, v10}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setOverScrollMode(I)V
    ...
    invoke-virtual {v8, v12}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setItemBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v8, v10}, Lcom/google/android/material/internal/NavigationMenu;->addMenuPresenter(Landroidx/appcompat/view/menu/MenuPresenter;)V
