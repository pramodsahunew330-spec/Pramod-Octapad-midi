...
.method public static whenAll(Ljava/util/Collection;)Lcom/google/android/gms/tasks/Task;
    .locals 3
    .param p0, "tasks"    # Ljava/util/Collection;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .end local p0    # "tasks":Ljava/util/Collection;
    if-eqz p0, :cond_4
...
.method public static varargs whenAll([Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    .locals 1
    .param p0, "tasks"    # [Lcom/google/android/gms/tasks/Task;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
            "Lcom/google/android/gms/tasks/Task<",
    ...
    .end local p0    # "tasks":[Lcom/google/android/gms/tasks/Task;
    if-eqz p0, :cond_1
...
.method public static whenAllComplete(Ljava/util/concurrent/Executor;Ljava/util/Collection;)Lcom/google/android/gms/tasks/Task;
    ...
    .end local p0    # "executor":Ljava/util/concurrent/Executor;
    .end local p1    # "tasks":Ljava/util/Collection;
    if-eqz p1, :cond_1
...
.method public static varargs whenAllComplete(Ljava/util/concurrent/Executor;[Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    .locals 1
    .param p0, "executor"    # Ljava/util/concurrent/Executor;
    .param p1, "tasks"    # [Lcom/google/android/gms/tasks/Task;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/concurrent/Executor;",
    ...
    .end local p0    # "executor":Ljava/util/concurrent/Executor;
    .end local p1    # "tasks":[Lcom/google/android/gms/tasks/Task;
    if-eqz p1, :cond_1
