...
.method protected constructor <init>(Lcom/google/android/gms/common/api/internal/ListenerHolder;)V
    .locals 2
    .param p1, "listenerHolder"    # Lcom/google/android/gms/common/api/internal/ListenerHolder;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .end local p0    # "this":Lcom/google/android/gms/common/api/internal/RegisterListenerMethod;
    .end local p1    # "listenerHolder":Lcom/google/android/gms/common/api/internal/ListenerHolder;
    const/4 v0, 0x0
...
.method protected constructor <init>(Lcom/google/android/gms/common/api/internal/ListenerHolder;[Lcom/google/android/gms/common/Feature;Z)V
    .locals 1
    .param p1, "listenerHolder"    # Lcom/google/android/gms/common/api/internal/ListenerHolder;
    .param p2, "requiredFeatures"    # [Lcom/google/android/gms/common/Feature;
    .param p3, "shouldAutoResolveMissingFeatures"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/google/android/gms/common/api/internal/ListenerHolder<",
    ...
    .end local p0    # "this":Lcom/google/android/gms/common/api/internal/RegisterListenerMethod;
    .end local p1    # "listenerHolder":Lcom/google/android/gms/common/api/internal/ListenerHolder;
    .end local p2    # "requiredFeatures":[Lcom/google/android/gms/common/Feature;
    .end local p3    # "shouldAutoResolveMissingFeatures":Z
    const/4 v0, 0x0
