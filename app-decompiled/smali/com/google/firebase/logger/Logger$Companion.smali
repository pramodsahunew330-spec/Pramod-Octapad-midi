...
.method public final getLogger(Ljava/lang/String;ZLcom/google/firebase/logger/Logger$Level;)Lcom/google/firebase/logger/Logger;
    ...
    .line 180
    .local v2, "$i$a$-getOrPut-Logger$Companion$getLogger$1":I
    new-instance v3, Lcom/google/firebase/logger/Logger$AndroidLogger;

    invoke-direct {v3, p1, p2, p3}, Lcom/google/firebase/logger/Logger$AndroidLogger;-><init>(Ljava/lang/String;ZLcom/google/firebase/logger/Logger$Level;)V

    check-cast v3, Lcom/google/firebase/logger/Logger;

    .line 198
    .end local v2    # "$i$a$-getOrPut-Logger$Companion$getLogger$1":I
    move-object v2, v3
    ...
    check-cast v2, Lcom/google/firebase/logger/Logger;
...
.method public final setupFakeLogger(Ljava/lang/String;ZLcom/google/firebase/logger/Logger$Level;)Lcom/google/firebase/logger/Logger$FakeLogger;
    ...
    .line 191
    .local v0, "fakeLogger":Lcom/google/firebase/logger/Logger$FakeLogger;
    invoke-static {}, Lcom/google/firebase/logger/Logger;->access$getLoggers$cp()Ljava/util/concurrent/ConcurrentHashMap;
