...
.method private pruneTreeRecursive(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/utilities/ImmutableTree;Lcom/google/firebase/database/core/utilities/ImmutableTree;Lcom/google/firebase/database/core/persistence/PruneForest;Ljava/util/List;)V
    ...
    new-instance v12, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine$2;
    ...
    invoke-virtual {v9, v0, v12}, Lcom/google/firebase/database/core/persistence/PruneForest;->foldKeptNodes(Ljava/lang/Object;Lcom/google/firebase/database/core/utilities/ImmutableTree$TreeVisitor;)Ljava/lang/Object;
...
.method private saveWrite(Lcom/google/firebase/database/core/Path;JLjava/lang/String;[B)V
    ...
    invoke-virtual {v14, v5, v11, v13, v4}, Landroid/database/sqlite/SQLiteDatabase;->insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
    ...
    invoke-virtual {v6, v5, v11, v3, v4}, Landroid/database/sqlite/SQLiteDatabase;->insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
...
.method private updateServerCache(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;Z)V
    ...
    .line 376
    .local v5, "removedRows":I
    const/4 v6, 0x0

    .line 377
    .local v6, "savedRows":I
    ...
    .line 378
    .local v8, "child":Lcom/google/firebase/database/snapshot/NamedNode;
    ...
    .line 380
    .end local v8    # "child":Lcom/google/firebase/database/snapshot/NamedNode;
    goto :goto_0
    ...
    .line 390
    invoke-virtual/range {p1 .. p1}, Lcom/google/firebase/database/core/Path;->toString()Ljava/lang/String;
...
.method public loadTrackedQueryKeys(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 630
    invoke-virtual {v0, v4, v8}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public pruneCache(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/persistence/PruneForest;)V
    ...
    invoke-static {v3, v1, v13}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 704
    invoke-virtual {v2, v1, v0}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public saveTrackedQueryKeys(JLjava/util/Set;)V
    ...
    .line 551
    iget-object v9, v0, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->database:Landroid/database/sqlite/SQLiteDatabase;

    const/4 v10, 0x0

    const/4 v11, 0x5

    invoke-virtual {v9, v7, v10, v8, v11}, Landroid/database/sqlite/SQLiteDatabase;->insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
    ...
    .line 556
    .local v5, "duration":J
    iget-object v7, v0, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->logger:Lcom/google/firebase/database/logging/LogWrapper;
...
.method public updateTrackedQueryKeys(JLjava/util/Set;Ljava/util/Set;)V
    ...
    iget-object v8, v0, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->database:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 576
    invoke-virtual {v8, v7, v3, v9}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 589
    const-string v9, "Updated tracked query keys (%d added, %d removed) for tracked query id %d in %dms"
