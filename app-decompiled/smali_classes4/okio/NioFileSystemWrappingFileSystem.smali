...
.method public constructor <init>(Ljava/nio/file/FileSystem;)V
    .locals 1
    .param p1, "nioFileSystem"    # Ljava/nio/file/FileSystem;
...
.method private final list(Lokio/Path;Z)Ljava/util/List;
    ...
    .line 67
    .local v0, "nioDir":Ljava/nio/file/Path;
    nop
    ...
    :try_start_0
    invoke-static {v0, v2, v1, v2}, Lkotlin/io/path/PathsKt;->listDirectoryEntries$default(Ljava/nio/file/Path;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/List;
    ...
    .line 77
    .local v8, "$i$a$-mapTo-NioFileSystemWrappingFileSystem$list$result$1":I
    invoke-virtual {v7}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {p1, v9}, Lokio/Path;->resolve(Ljava/lang/String;)Lokio/Path;

    move-result-object v7

    .line 194
    .end local v7    # "entry":Ljava/nio/file/Path;
    .end local v8    # "$i$a$-mapTo-NioFileSystemWrappingFileSystem$list$result$1":I
...
.method private final resolve(Lokio/Path;)Ljava/nio/file/Path;
    .locals 3
    .param p1, "$this$resolve"    # Lokio/Path;
    ...
    const-string v1, "nioFileSystem.getPath(toString())"
...
.method public appendingSink(Lokio/Path;Z)Lokio/Sink;
    ...
    .local v1, "$this$appendingSink_u24lambda_u244":Ljava/util/List;
    const/4 v2, 0x0

    .line 134
    .local v2, "$i$a$-buildList-NioFileSystemWrappingFileSystem$appendingSink$openOptions$1":I
    ...
    .line 133
    .end local v1    # "$this$appendingSink_u24lambda_u244":Ljava/util/List;
    .end local v2    # "$i$a$-buildList-NioFileSystemWrappingFileSystem$appendingSink$openOptions$1":I
    invoke-static {v0}, Lkotlin/collections/CollectionsKt;->build(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    .line 137
    .local v0, "openOptions":Ljava/util/List;
    invoke-direct {p0, p1}, Lokio/NioFileSystemWrappingFileSystem;->resolve(Lokio/Path;)Ljava/nio/file/Path;
    ...
    new-array v5, v5, [Ljava/nio/file/StandardOpenOption;
    ...
    check-cast v2, [Ljava/nio/file/StandardOpenOption;
    ...
    const-string v2, "newOutputStream(this, *options)"
...
.method public atomicMove(Lokio/Path;Lokio/Path;)V
    ...
    check-cast v4, Ljava/nio/file/CopyOption;
...
.method public createDirectory(Lokio/Path;Z)V
    ...
    const-string v2, "createDirectory(this, *attributes)"
...
.method public delete(Lokio/Path;Z)V
    ...
    .line 177
    .local v0, "nioPath":Ljava/nio/file/Path;
    nop
    ...
    .line 180
    .local v1, "e":Ljava/nio/file/NoSuchFileException;
    if-nez p2, :cond_1

    .line 184
    .end local v1    # "e":Ljava/nio/file/NoSuchFileException;
    :goto_0
    return-void

    .line 180
    .restart local v1    # "e":Ljava/nio/file/NoSuchFileException;
    :cond_1
    new-instance v2, Ljava/io/FileNotFoundException;
    ...
    .line 174
    .end local v0    # "nioPath":Ljava/nio/file/Path;
    .end local v1    # "e":Ljava/nio/file/NoSuchFileException;
    :cond_2
...
.method public openReadOnly(Lokio/Path;)Lokio/FileHandle;
    ...
    invoke-direct {v1, v3, v0}, Lokio/NioFileSystemFileHandle;-><init>(ZLjava/nio/channels/FileChannel;)V
...
.method public openReadWrite(Lokio/Path;ZZ)Lokio/FileHandle;
    ...
    .local v3, "$this$openReadWrite_u24lambda_u242":Ljava/util/List;
    const/4 v4, 0x0

    .line 94
    .local v4, "$i$a$-buildList-NioFileSystemWrappingFileSystem$openReadWrite$openOptions$1":I
    ...
    .line 93
    .end local v3    # "$this$openReadWrite_u24lambda_u242":Ljava/util/List;
    .end local v4    # "$i$a$-buildList-NioFileSystemWrappingFileSystem$openReadWrite$openOptions$1":I
    invoke-static {v2}, Lkotlin/collections/CollectionsKt;->build(Ljava/util/List;)Ljava/util/List;

    move-result-object v2

    .line 103
    .local v2, "openOptions":Ljava/util/List;
    nop
    ...
    .line 108
    .local v0, "channel":Ljava/nio/channels/FileChannel;
    new-instance v3, Lokio/NioFileSystemFileHandle;

    const-string v4, "channel"

    invoke-static {v0, v4}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {v3, v1, v0}, Lokio/NioFileSystemFileHandle;-><init>(ZLjava/nio/channels/FileChannel;)V

    check-cast v3, Lokio/FileHandle;
    ...
    .end local v2    # "openOptions":Ljava/util/List;
    :cond_4
    const/4 v0, 0x0

    .line 92
    .local v0, "$i$a$-require-NioFileSystemWrappingFileSystem$openReadWrite$1":I
    nop

    .end local v0    # "$i$a$-require-NioFileSystemWrappingFileSystem$openReadWrite$1":I
...
.method public sink(Lokio/Path;Z)Lokio/Sink;
    ...
    .local v1, "$this$sink_u24lambda_u243":Ljava/util/List;
    const/4 v2, 0x0

    .line 121
    .local v2, "$i$a$-buildList-NioFileSystemWrappingFileSystem$sink$openOptions$1":I
    if-eqz p2, :cond_0
    ...
    .line 120
    .end local v1    # "$this$sink_u24lambda_u243":Ljava/util/List;
    .end local v2    # "$i$a$-buildList-NioFileSystemWrappingFileSystem$sink$openOptions$1":I
    invoke-static {v0}, Lkotlin/collections/CollectionsKt;->build(Ljava/util/List;)Ljava/util/List;
