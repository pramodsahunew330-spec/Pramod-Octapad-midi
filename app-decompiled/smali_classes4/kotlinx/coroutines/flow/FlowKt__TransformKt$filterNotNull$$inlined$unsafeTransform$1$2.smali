...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Lkotlinx/coroutines/flow/FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v3, v0, Lkotlinx/coroutines/flow/FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$1;->label:I
    ...
    .line 49
    .local v3, "this":Lkotlinx/coroutines/flow/FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v4, v3, Lkotlinx/coroutines/flow/FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;

    .local v4, "$this$filterNotNull_u24lambda_u244":Lkotlinx/coroutines/flow/FlowCollector;
    move-object v3, v0

    check-cast v3, Lkotlin/coroutines/Continuation;

    .end local v3    # "this":Lkotlinx/coroutines/flow/FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2;
    move-object v3, v4

    .end local v4    # "$this$filterNotNull_u24lambda_u244":Lkotlinx/coroutines/flow/FlowCollector;
    .local v3, "$this$filterNotNull_u24lambda_u244":Lkotlinx/coroutines/flow/FlowCollector;
    const/4 v4, 0x0

    .line 50
    .local v4, "$i$a$-unsafeTransform-FlowKt__TransformKt$filterNotNull$1":I
    if-eqz p1, :cond_2

    const/4 v5, 0x1

    iput v5, v0, Lkotlinx/coroutines/flow/FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$1;->label:I
    ...
    .end local v4    # "$i$a$-unsafeTransform-FlowKt__TransformKt$filterNotNull$1":I
    .local p1, "$i$a$-unsafeTransform-FlowKt__TransformKt$filterNotNull$1":I
    :goto_1
    goto :goto_2
    ...
    .line 51
    .end local p1    # "$i$a$-unsafeTransform-FlowKt__TransformKt$filterNotNull$1":I
    .restart local v4    # "$i$a$-unsafeTransform-FlowKt__TransformKt$filterNotNull$1":I
    :cond_2
    nop
