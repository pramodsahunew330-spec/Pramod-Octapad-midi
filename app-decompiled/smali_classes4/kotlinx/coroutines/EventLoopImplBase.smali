...
.method private final closeQueue()V
    ...
    .line 349
    .local v3, "$i$a$-loop$atomicfu-EventLoopImplBase$closeQueue$2":I
    nop
    ...
    .end local v3    # "$i$a$-loop$atomicfu-EventLoopImplBase$closeQueue$2":I
    goto :goto_1
.end method
...
.method private final dequeue()Ljava/lang/Runnable;
    ...
    .line 312
    .local v3, "$i$a$-loop$atomicfu-EventLoopImplBase$dequeue$1":I
    nop
    ...
    .end local v2    # "queue":Ljava/lang/Object;
    .end local v3    # "$i$a$-loop$atomicfu-EventLoopImplBase$dequeue$1":I
    goto :goto_0
.end method
...
.method private final enqueueImpl(Ljava/lang/Runnable;)Z
    ...
    .line 285
    .local v3, "$i$a$-loop$atomicfu-EventLoopImplBase$enqueueImpl$1":I
    invoke-direct {p0}, Lkotlinx/coroutines/EventLoopImplBase;->isCompleted()Z
    ...
    .end local v2    # "queue":Ljava/lang/Object;
    .end local v3    # "$i$a$-loop$atomicfu-EventLoopImplBase$enqueueImpl$1":I
    goto :goto_0
