...
.method private final parse(Ljava/net/URL;)Ljava/util/List;
    ...
    .local v2, "$this$use$iv":Ljava/util/jar/JarFile;
    move-object v5, p0

    .local v5, "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
    const/4 v6, 0x0
    ...
    .line 198
    .end local v2    # "$this$use$iv":Ljava/util/jar/JarFile;
    .end local v5    # "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
    ...
    .restart local v2    # "$this$use$iv":Ljava/util/jar/JarFile;
    .restart local v5    # "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
...
.method public final loadMainDispatcherFactory$kotlinx_coroutines_core()Ljava/util/List;
    ...
    .line 174
    .local v8, "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    move-object v9, v5

    .line 170
    .end local v8    # "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    :goto_0
    nop
    ...
    .line 63
    .local v2, "mainFactory":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    if-nez v2, :cond_1
    ...
    invoke-direct {p0, v0, v3}, Lkotlinx/coroutines/internal/FastServiceLoader;->load(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    .local v3, "serviceClass$iv":Ljava/lang/String;
    move-object v4, p0

    .local v4, "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
    const/4 v8, 0x0

    .line 175
    .local v8, "$i$f$createInstanceOf":I
    nop
    ...
    .line 179
    .local v6, "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    nop

    .line 175
    .end local v6    # "<unused var>$iv":Ljava/lang/ClassNotFoundException;
    :goto_1
    nop

    .line 69
    .end local v3    # "serviceClass$iv":Ljava/lang/String;
    .end local v4    # "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
    .end local v8    # "$i$f$createInstanceOf":I
    if-eqz v5, :cond_2

    move-object v3, v5

    .line 180
    .local v3, "$this$loadMainDispatcherFactory_u24lambda_u240":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    const/4 v4, 0x0

    .line 69
    .local v4, "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$1":I
    :try_start_4
    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 70
    .end local v3    # "$this$loadMainDispatcherFactory_u24lambda_u240":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    .end local v4    # "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$1":I
    :cond_2
    nop

    .end local v1    # "result":Ljava/util/ArrayList;
    .end local v2    # "mainFactory":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    ...
    .line 73
    .local v1, "<unused var>":Ljava/lang/Throwable;
    invoke-virtual {v0}, Ljava/lang/Class;->getClassLoader()Ljava/lang/ClassLoader;
    ...
    .line 60
    .end local v1    # "<unused var>":Ljava/lang/Throwable;
    :goto_2
    return-object v1
.end method
