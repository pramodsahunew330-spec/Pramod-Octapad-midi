...
public class LoopsActivity extends Activity {
    ...
    private static final int MAX_PRESET_LOOPS = 20;
    ...
    private String[] presetLoopNames = new String[20];
    private int[][] presetLoopResourceIds = new int[20][8];
    private int currentPresetLoop = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) throws IllegalStateException {
        ...
        Button repeatButton = this.btnRepeat;
        if (repeatButton != null) {
            repeatButton.setText(this.isOneShotMode ? "REPEAT OFF" : "REPEAT ON");
        }
        setupReverb();
        initLoopPresets();
        setupControls();
        ...
        if (button5 != null) {
            button5.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.octapadpromidi.LoopsActivity.9
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    String[] options = {"Load Preset Loops", "Load From Folder"};
                    new AlertDialog.Builder(LoopsActivity.this).setTitle("LOAD LOOPS").setItems(options, new DialogInterface.OnClickListener() {
                        @Override // android.content.DialogInterface.OnClickListener
                        public void onClick(DialogInterface dialog, int which) {
                            if (which == 0) {
                                LoopsActivity.this.showPresetLoopsDialog();
                            } else {
        ...
        Button button7 = this.btnRepeat;
        if (button7 != null) {
            button7.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.octapadpromidi.LoopsActivity.13
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    LoopsActivity.this.isOneShotMode = !LoopsActivity.this.isOneShotMode;
                    LoopsActivity.this.prefs.edit().putBoolean("loop_one_shot_mode", LoopsActivity.this.isOneShotMode).apply();
                    CheckBox checkBox = LoopsActivity.this.chkOneShotMode;
                    if (checkBox != null) {
                        checkBox.setChecked(LoopsActivity.this.isOneShotMode);
                    }
                    LoopsActivity.this.btnRepeat.setText(LoopsActivity.this.isOneShotMode ? "REPEAT OFF" : "REPEAT ON");
                    for (int i = 0; i < 8; i++) {
    ...
    private void initLoopPresets() {
        String[] presetNames = this.presetLoopNames;
        presetNames[0] = "Ambient Loops 1";
        presetNames[1] = "Electronic Loops";
        presetNames[2] = "Hip Hop Beats";
        presetNames[3] = "Smooth Jazz";
        presetNames[4] = "Rock Loops";
        presetNames[5] = "Pop Rhythms";
        presetNames[6] = "Reggae Vibes";
        presetNames[7] = "Soul Grooves";
        presetNames[8] = "Funk Loops";
        presetNames[9] = "Latin Rhythms";
        presetNames[10] = "Indian Classical";
        presetNames[11] = "World Fusion";
        presetNames[12] = "Techno Beats";
        presetNames[13] = "House Loops";
        presetNames[14] = "Breakbeats";
        presetNames[15] = "Ambient Loops 2";
        presetNames[16] = "Chillout Mix";
        presetNames[17] = "Vocal Loops";
        presetNames[18] = "Instrumental Loops";
        presetNames[19] = "Mixed Genres";

        int[][] presetIds = this.presetLoopResourceIds;
        for (int i = 0; i < 20; i++) {
            String suffix = i == 0 ? "" : String.valueOf(i + 1);
            int[] loopSet = new int[8];
            loopSet[0] = getResources().getIdentifier("loop_pad1" + suffix, "raw", getPackageName());
            loopSet[1] = getResources().getIdentifier("loop_pad2" + suffix, "raw", getPackageName());
            loopSet[2] = getResources().getIdentifier("loop_pad3" + suffix, "raw", getPackageName());
            loopSet[3] = getResources().getIdentifier("loop_pad4" + suffix, "raw", getPackageName());
            loopSet[4] = getResources().getIdentifier("loop_pad5" + suffix, "raw", getPackageName());
            loopSet[5] = getResources().getIdentifier("loop_pad6" + suffix, "raw", getPackageName());
            loopSet[6] = getResources().getIdentifier("loop_pad7" + suffix, "raw", getPackageName());
            loopSet[7] = getResources().getIdentifier("loop_pad8" + suffix, "raw", getPackageName());
            presetIds[i] = loopSet;
        }
    }

    public void loadPresetLoop(int presetIndex) {
        if (presetIndex < 0 || presetIndex >= 20) {
            return;
        }
        this.currentPresetLoop = presetIndex;
        this.currentLoopName = this.presetLoopNames[presetIndex];
        this.txtLoopChannel.setText(this.currentLoopName);
        
        int[] resourceIds = this.presetLoopResourceIds[presetIndex];
        for (int i = 0; i < 8; i++) {
            ...
            if (resourceIds[i] != 0) {
                try {
                    this.mediaPlayers[i] = MediaPlayer.create(this, resourceIds[i]);
                    if (this.mediaPlayers[i] != null) {
                        this.mediaPlayers[i].setLooping(!this.isOneShotMode);
                        preloadLoop(i);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
        ...
        Toast.makeText(this, "Preset Loop: " + this.currentLoopName + " Loaded!", 0).show();
    }

    public void showPresetLoopsDialog() {
        new AlertDialog.Builder(this).setTitle("SELECT PRESET LOOP KIT").setItems(this.presetLoopNames, new DialogInterface.OnClickListener(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.24
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                this.this$0.loadPresetLoop(which);
            }
        }).setNegativeButton("Cancel", (DialogInterface.OnClickListener) null).show();
    }
    ...
    private void initPads() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            final int index = i;
            this.loopPads[i].setOnTouchListener(new View.OnTouchListener(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.15
                final /* synthetic */ LoopsActivity this$0;
    ...
    private void toggleLoop(final int index) throws IllegalStateException {
        ...
        mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.16
            final /* synthetic */ LoopsActivity this$0;
            ...
            public void onCompletion(MediaPlayer mediaPlayer2) throws IllegalStateException {
                if (this.this$0.isOneShotMode) {
                    this.this$0.loopPads[index].setBackgroundResource(R.drawable.pad_black_selector);
                    this.this$0.txtLoopStatus.setText("LOOP " + (index + 1) + " FINISHED");
    ...
    private void showEditOptions(final int index) {
        ...
        new AlertDialog.Builder(this).setTitle("EDIT LOOP " + (index + 1)).setItems(options, new DialogInterface.OnClickListener(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.17
            final /* synthetic */ LoopsActivity this$0;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_PICK_LOOP_WAV) {
            ...
            if (mediaPlayer2 != null) {
                mediaPlayer2.setLooping(true ^ this.isOneShotMode);
    ...
    public void renameLoopDialog() {
        ...
        new AlertDialog.Builder(this).setTitle("Enter Loop Name").setView(edt).setPositiveButton("OK", new DialogInterface.OnClickListener(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.18
            final /* synthetic */ LoopsActivity this$0;
    ...
    public void showSaveLoopNameDialog() {
        ...
        edt.setText(this.currentLoopName);
        new AlertDialog.Builder(this).setTitle("Save Loop Group As").setView(edt).setPositiveButton("NEXT", new DialogInterface.OnClickListener(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.19
            final /* synthetic */ LoopsActivity this$0;
        ...
        for (int i2 = 0; i2 < 8; i2++) {
            ...
            if (uriStr != null) {
                ...
                try {
                    ...
                    if (mediaPlayer2 != null) {
                        mediaPlayer2.setLooping(!this.isOneShotMode);
                        preloadLoop(i2);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void handleMidiNoteOn(byte note, byte velocity) {
        ...
        runOnUiThread(new Runnable(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.22
            final /* synthetic */ LoopsActivity this$0;
            ...
            public void run() throws IllegalStateException {
                ...
                if (i >= 0 && i < 8) {
                    ...
                    handler.postDelayed(new Runnable(this) { // from class: com.pramod.octapadpromidi.LoopsActivity.22.1
    ...
    private boolean prepareLoopPlayer(int index) {
        boolean z;
        if (index < 0 || index >= 8 || this.loopUris[index] == null) {
            return false;
        }
        try {
            MediaPlayer existing = this.mediaPlayers[index];
            if (existing != null) {
                return true;
            }
            MediaPlayer mp = MediaPlayer.create(this, this.loopUris[index]);
            if (mp == null) {
                return false;
            }
