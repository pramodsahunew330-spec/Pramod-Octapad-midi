...
public final class DatabaseKt$snapshots$1$listener$1 implements ValueEventListener {
    ...
    public DatabaseKt$snapshots$1$listener$1(Query $receiver, ProducerScope<? super DataSnapshot> producerScope) {
    ...
    public void onDataChange(final DataSnapshot snapshot) {
        ...
        repo.scheduleNow(new Runnable() { // from class: com.google.firebase.database.DatabaseKt$snapshots$1$listener$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                DatabaseKt$snapshots$1$listener$1.onDataChange$lambda$0(ProducerScope.this, snapshot);
            }
        });
    }
