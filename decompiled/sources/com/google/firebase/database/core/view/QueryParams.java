...
public final class QueryParams {
    ...
    public QueryParams startAt(Node indexStartValue, ChildKey indexStartName) {
        Utilities.hardAssert(indexStartValue.isLeafNode() || indexStartValue.isEmpty());
    ...
    public QueryParams endAt(Node indexEndValue, ChildKey indexEndName) {
        Utilities.hardAssert(indexEndValue.isLeafNode() || indexEndValue.isEmpty());
    ...
    public int hashCode() {
        ...
        int result2 = ((((((((((result * 31) + (isViewFromLeft() ? 1231 : 1237)) * 31) + (this.indexStartValue != null ? this.indexStartValue.hashCode() : 0)) * 31) + (this.indexStartName != null ? this.indexStartName.hashCode() : 0)) * 31) + (this.indexEndValue != null ? this.indexEndValue.hashCode() : 0)) * 31) + (this.indexEndName != null ? this.indexEndName.hashCode() : 0)) * 31;
        if (this.index != null) {
