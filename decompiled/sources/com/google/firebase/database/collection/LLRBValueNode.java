...
public abstract class LLRBValueNode<K, V> implements LLRBNode<K, V> {
    ...
    /* renamed from: copy */
    public /* bridge */ /* synthetic */ LLRBNode mo548copy(Object obj, Object obj2, LLRBNode.Color color, LLRBNode lLRBNode, LLRBNode lLRBNode2) {
        return mo548copy((LLRBValueNode<K, V>) obj, obj2, color, (LLRBNode<LLRBValueNode<K, V>, Object>) lLRBNode, (LLRBNode<LLRBValueNode<K, V>, Object>) lLRBNode2);
    }
    ...
    public LLRBValueNode<K, V> mo548copy(K key, V value, LLRBNode.Color color, LLRBNode<K, V> left, LLRBNode<K, V> right) {
    ...
    private LLRBValueNode<K, V> rotateLeft() {
        LLRBValueNode<K, V> newLeft = mo548copy((LLRBValueNode<K, V>) null, (K) null, LLRBNode.Color.RED, (LLRBNode<LLRBValueNode<K, V>, K>) null, (LLRBNode<LLRBValueNode<K, V>, K>) ((LLRBValueNode) this.right).left);
        return (LLRBValueNode) this.right.mo548copy(null, null, getColor(), newLeft, null);
    }

    private LLRBValueNode<K, V> rotateRight() {
        LLRBValueNode<K, V> newRight = mo548copy((LLRBValueNode<K, V>) null, (K) null, LLRBNode.Color.RED, (LLRBNode<LLRBValueNode<K, V>, K>) ((LLRBValueNode) this.left).right, (LLRBNode<LLRBValueNode<K, V>, K>) null);
        return (LLRBValueNode) this.left.mo548copy(null, null, getColor(), null, newRight);
    }

    private LLRBValueNode<K, V> colorFlip() {
        LLRBNode<K, V> newLeft = this.left.mo548copy(null, null, oppositeColor(this.left), null, null);
        LLRBNode<K, V> newRight = this.right.mo548copy(null, null, oppositeColor(this.right), null, null);
        return mo548copy((LLRBValueNode<K, V>) null, (K) null, oppositeColor(this), (LLRBNode<LLRBValueNode<K, V>, K>) newLeft, (LLRBNode<LLRBValueNode<K, V>, K>) newRight);
    }
}
