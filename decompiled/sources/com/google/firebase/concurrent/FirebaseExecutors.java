...
public class FirebaseExecutors {
    ...
    public static ScheduledExecutorService newLimitedConcurrencyScheduledExecutorService(ExecutorService delegate, int concurrency) {
        return new DelegatingScheduledExecutorService(newLimitedConcurrencyExecutorService(delegate, concurrency), ExecutorsRegistrar.SCHEDULER.mo529get());
    }
    ...
    public static PausableScheduledExecutorService newPausableScheduledExecutorService(ScheduledExecutorService delegate) {
        return new PausableScheduledExecutorServiceImpl(newPausableExecutorService(delegate), ExecutorsRegistrar.SCHEDULER.mo529get());
    }
