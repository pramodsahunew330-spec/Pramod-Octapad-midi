...
public abstract class GmsClient<T extends IInterface> extends BaseGmsClient<T> implements Api.Client, zaj {
    ...
    @Deprecated
    public GmsClient(Context context, Looper looper, int gCoreServiceId, ClientSettings clientSettings, GoogleApiClient.ConnectionCallbacks connectedListener, GoogleApiClient.OnConnectionFailedListener connectionFailedListener) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public GmsClient(Context context, Looper looper, int gCoreServiceId, ClientSettings clientSettings, ConnectionCallbacks connectedListener, OnConnectionFailedListener connectionFailedListener) {
