...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public static <T extends FastJsonResponse> Field<T, T> forConcreteType(String fieldName, int safeParcelableId, Class<T> cls) {
            return new Field<>(11, false, 11, false, fieldName, safeParcelableId, cls, null);
        }

        public static <T extends FastJsonResponse> Field<ArrayList<T>, ArrayList<T>> forConcreteTypeArray(String fieldName, int safeParcelableId, Class<T> cls) {
            return new Field<>(11, true, 11, true, fieldName, safeParcelableId, cls, null);
        }
        ...
        public static Field withConverter(String outputFieldName, int safeParcelableId, FieldConverter<?, ?> fieldConverter, boolean inputArrayType) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, inputArrayType, 0, false, outputFieldName, safeParcelableId, null, fieldConverter);
        }
