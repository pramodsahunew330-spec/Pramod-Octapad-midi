...
public final class ListenerHolder<L> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ListenerHolder(Looper looper, L l, String listenerType) {
        this.zaa = new HandlerExecutor(looper);
        this.zab = Preconditions.checkNotNull(l, "Listener must not be null");
        this.zac = new ListenerKey(l, Preconditions.checkNotEmpty(listenerType));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ListenerHolder(Executor executor, L l, String listenerType) {
