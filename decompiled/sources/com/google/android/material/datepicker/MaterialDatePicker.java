...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ViewCompat.setAccessibilityDelegate(this.confirmButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialDatePicker.2
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                String contentDescription = MaterialDatePicker.this.getDateSelector().getError() + ", " + ((Object) info.getText());
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
    ...
    public final S getSelection() {
        return getDateSelector().mo399getSelection();
    }
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(headerLayout, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.4
