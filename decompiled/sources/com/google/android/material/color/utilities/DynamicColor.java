...
public final class DynamicColor {
    ...
    public static DynamicColor fromArgb(final int argb, Function<DynamicScheme, Double> tone) {
        return fromPalette(new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda10
            ...
            public final Object apply(Object obj) {
                ...
                DynamicScheme dynamicScheme = (DynamicScheme) obj;
                fromInt = TonalPalette.fromInt(argb);
                return fromInt;
            }
        }, tone);
    }
    ...
    public static DynamicColor fromPalette(final Function<DynamicScheme, TonalPalette> palette, final Function<DynamicScheme, Double> tone, final Function<DynamicScheme, DynamicColor> background, final Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return new DynamicColor(new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda17
            ...
            public final Object apply(Object obj) {
                Double valueOf;
                valueOf = Double.valueOf(((TonalPalette) palette.apply((DynamicScheme) obj)).getHue());
                return valueOf;
            }
            ...
            public final Object apply(Object obj) {
                Double valueOf;
                valueOf = Double.valueOf(((TonalPalette) palette.apply((DynamicScheme) obj)).getChroma());
                return valueOf;
            }
        }, tone, null, background, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
                valueOf = Double.valueOf(DynamicColor.toneMinContrastDefault(tone, background, (DynamicScheme) obj, toneDeltaConstraint));
                return valueOf;
            }
            ...
            public final Object apply(Object obj) {
                Double valueOf;
                valueOf = Double.valueOf(DynamicColor.toneMaxContrastDefault(tone, background, (DynamicScheme) obj, toneDeltaConstraint));
                return valueOf;
            }
        }, toneDeltaConstraint);
    }
    ...
    public double getTone(final DynamicScheme scheme) {
        ...
        final DynamicColor bgDynamicColor = this.background == null ? null : this.background.apply(scheme);
        if (bgDynamicColor == null) {
            maxRatio = 21.0d;
            minRatio = 1.0d;
        } else {
            if (bgDynamicColor.background == null || bgDynamicColor.background.apply(scheme) == null) {
                z = false;
            }
            boolean bgHasBg = z;
        ...
        double answer3 = calculateDynamicTone(scheme, this.tone, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda11
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
            ...
            public final Object apply(Object obj, Object obj2) {
                ...
                valueOf = Double.valueOf(finalAnswer);
                return valueOf;
            }
            ...
            public final Object apply(Object obj) {
                Double valueOf;
                Double d = (Double) obj;
                valueOf = Double.valueOf(finalMinRatio);
                return valueOf;
            }
            ...
            public final Object apply(Object obj) {
                Double valueOf;
                Double d = (Double) obj;
                valueOf = Double.valueOf(finalMaxRatio);
                return valueOf;
            }
        });
        return answer3;
    ...
    public static double toneMinContrastDefault(final Function<DynamicScheme, Double> tone, final Function<DynamicScheme, DynamicColor> background, final DynamicScheme scheme, Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return calculateDynamicTone(scheme, tone, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda7
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double apply;
        ...
        }, background, toneDeltaConstraint, null, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda9
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    public static double toneMaxContrastDefault(Function<DynamicScheme, Double> tone, final Function<DynamicScheme, DynamicColor> background, final DynamicScheme scheme, Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return calculateDynamicTone(scheme, tone, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda5
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double apply;
