...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float shadowScaleHorizontal2 = shadowOffset / (shadowOffset + shadowOffsetHorizontal2);
        float shadowScaleTop2 = shadowOffset / (shadowOffset + shadowOffsetTop);
        float shadowScaleBottom3 = shadowOffset / (shadowOffset + shadowOffsetBottom);
        ...
        canvas.scale(shadowScaleHorizontal, shadowScaleBottom4);
        ...
        canvas.scale(shadowScaleHorizontal, shadowScaleBottom2);
        canvas.rotate(270.0f);
        canvas.drawPath(this.cornerShadowPath, this.cornerShadowPaint);
        if (drawVerticalEdges) {
            canvas.scale(1.0f / shadowScaleBottom2, 1.0f);
        ...
        canvas.scale(shadowScaleHorizontal, shadowScaleTop3);
        canvas.rotate(90.0f);
        canvas.drawPath(this.cornerShadowPath, this.cornerShadowPaint);
        if (drawVerticalEdges) {
