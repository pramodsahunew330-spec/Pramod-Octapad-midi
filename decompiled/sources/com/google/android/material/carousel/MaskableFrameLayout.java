...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.maskableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda1
            @Override // com.google.android.material.canvas.CanvasCompat.CanvasOperation
            public final void run(Canvas canvas2) {
                MaskableFrameLayout.this.m374x418c47c0(canvas2);
            }
        });
    }
    ...
    public /* synthetic */ void m374x418c47c0(Canvas x$0) {
