...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createDependencyTranslationAnimation(View dependency, View child, boolean expanded, FabTransformationSpec spec, List<Animator> animations) {
        ...
        ValueAnimator translationXAnimator = ObjectAnimator.ofFloat(dependency, View.TRANSLATION_X, expanded ? translationX : this.dependencyOriginalTranslationX);
        ValueAnimator translationYAnimator = ObjectAnimator.ofFloat(dependency, View.TRANSLATION_Y, expanded ? translationY : this.dependencyOriginalTranslationY);
