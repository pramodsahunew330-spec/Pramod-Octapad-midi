...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        T mo2027invoke;
        do {
            obj = (Object) mutableStateFlow.mo2322getValue();
            mo2027invoke = function1.mo2027invoke(obj);
        } while (!mutableStateFlow.compareAndSet(obj, mo2027invoke));
        return mo2027invoke;
    }
    ...
    public static final <T> T getAndUpdate(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ?? r1;
        do {
            r1 = (Object) mutableStateFlow.mo2322getValue();
        } while (!mutableStateFlow.compareAndSet(r1, function1.mo2027invoke(r1)));
        return r1;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            obj = (Object) mutableStateFlow.mo2322getValue();
        } while (!mutableStateFlow.compareAndSet(obj, function1.mo2027invoke(obj)));
    }
