...
public final class SafeCollector_commonKt$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object mo2029invoke = this.$block.mo2029invoke(flowCollector, continuation);
        return mo2029invoke == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? mo2029invoke : Unit.INSTANCE;
    }
    ...
    public Object collect$$forInline(FlowCollector<? super T> flowCollector, final Continuation<? super Unit> continuation) {
        ...
        InlineMarker.mark(5);
        this.$block.mo2029invoke(flowCollector, continuation);
