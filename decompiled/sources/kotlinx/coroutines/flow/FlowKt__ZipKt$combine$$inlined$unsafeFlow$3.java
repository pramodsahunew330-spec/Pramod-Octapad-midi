...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3 implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(collector, flowArr, new FlowKt__ZipKt$combine$6$1(this.$flowArray$inlined), new FlowKt__ZipKt$combine$6$2(this.$transform$inlined, null), $completion);
        InlineMarker.mark(1);
