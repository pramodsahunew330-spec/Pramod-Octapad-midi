...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                if (CombineKt.combineInternal($this$safeFlow, flowArr, new AnonymousClass1(this.$flows), new AnonymousClass2(this.$transform, null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal($this$safeFlow, flowArr, new AnonymousClass1(this.$flows), new AnonymousClass2(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
