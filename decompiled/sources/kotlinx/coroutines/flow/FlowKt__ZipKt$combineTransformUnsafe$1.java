...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\n"}, d2 = {"<anonymous>", "", "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, k = 3, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class FlowKt__ZipKt$combineTransformUnsafe$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* compiled from: Zip.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0006\b\u0001\u0010\u0003\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0006H\n"}, d2 = {"<anonymous>", "", "R", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, k = 3, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        ...
        /* renamed from: invoke */
        public final Object mo2351invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.L$0 = null;
                    this.label = 1;
                    if (function3.mo2351invoke($this$combineInternal, it, this) != coroutine_suspended) {
                        break;
                    } else {
        ...
        public final Object invokeSuspend$$forInline(Object $result) {
            FlowCollector $this$combineInternal = (FlowCollector) this.L$0;
            Object[] it = (Object[]) this.L$1;
            this.$transform.mo2351invoke($this$combineInternal, it, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                if (CombineKt.combineInternal($this$safeFlow, flowArr, nullArrayFactory$FlowKt__ZipKt, new AnonymousClass1(this.$transform, null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal($this$safeFlow, flowArr, nullArrayFactory$FlowKt__ZipKt, new AnonymousClass1(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
