...
public final class FlowKt__CollectKt$collectIndexed$2 implements FlowCollector<T> {
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        if (index$iv >= 0) {
            Object mo2351invoke = function3.mo2351invoke(Boxing.boxInt(index$iv), t, continuation);
            return mo2351invoke == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? mo2351invoke : Unit.INSTANCE;
        }
    ...
    public Object emit$$forInline(T t, final Continuation<? super Unit> continuation) {
        ...
        this.index = index$iv + 1;
        if (index$iv >= 0) {
            function3.mo2351invoke(Integer.valueOf(index$iv), t, continuation);
