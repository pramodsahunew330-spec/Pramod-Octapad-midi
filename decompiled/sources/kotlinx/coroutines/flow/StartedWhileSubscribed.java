...
public final class StartedWhileSubscribed implements SharingStarted {
    ...
    public int hashCode() {
        return (ULong$$ExternalSyntheticBackport0.m(this.stopTimeout) * 31) + ULong$$ExternalSyntheticBackport0.m(this.replayExpiration);
    }
}
