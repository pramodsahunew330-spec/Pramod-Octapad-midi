...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u00012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003H\n"}, d2 = {"<anonymous>", "", "value", "Lkotlinx/coroutines/channels/ChannelResult;", ""}, k = 3, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: invoke */
    public /* bridge */ /* synthetic */ Object mo2029invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m2304invokeWpGqRn0(channelResult.m2285unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m2304invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m2273boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m2285unboximpl = ((ChannelResult) this.L$0).m2285unboximpl();
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (!(m2285unboximpl instanceof ChannelResult.Failed)) {
                    objectRef2.element = m2285unboximpl;
                }
                objectRef = this.$lastValue;
                FlowCollector<T> flowCollector = this.$downstream;
                if (m2285unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m2277exceptionOrNullimpl(m2285unboximpl);
                    if (it != null) {
                        throw it;
                    }
