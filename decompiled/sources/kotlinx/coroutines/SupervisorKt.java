...
public final class SupervisorKt {
    ...
    public static /* synthetic */ Job m2253SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2252SupervisorJob(job);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* renamed from: SupervisorJob */
    public static final /* synthetic */ Job m2252SupervisorJob(Job parent) {
