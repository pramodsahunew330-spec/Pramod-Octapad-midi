...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo2336dispatch(getContext(), this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(12:13|(2:14|15)|(3:73|74|(10:76|77|18|(14:20|21|22|(2:58|59)(1:24)|25|26|27|28|29|30|31|32|(1:44)|36)(1:71)|37|(1:38)|40|41|42|43))|17|18|(0)(0)|37|(1:38)|40|41|42|43) */
    ...
    */
    public final void resumeCancellableWith$kotlinx_coroutines_core(java.lang.Object r23) {
        /*
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m660constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
