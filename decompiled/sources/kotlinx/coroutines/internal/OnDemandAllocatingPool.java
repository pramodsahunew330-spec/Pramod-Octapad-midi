...
public final class OnDemandAllocatingPool<T> {
    ...
    public final boolean allocate() {
        ...
        getElements().set(ctl, this.create.mo2027invoke(Integer.valueOf(ctl)));
        return true;
    }
    ...
    public final List<T> close() {
        ...
        while (true) {
            it$iv = handler$atomicfu$iv$iv.get(this);
            if (!((it$iv & Integer.MIN_VALUE) != 0)) {
                if (controlState$volatile$FU.compareAndSet(this, it$iv, it$iv | Integer.MIN_VALUE)) {
                    break;
                }
            } else {
                it$iv = 0;
