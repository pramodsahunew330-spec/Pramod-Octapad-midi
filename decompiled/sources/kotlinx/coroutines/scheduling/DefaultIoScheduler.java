...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    static {
        ...
        f3default = CoroutineDispatcher.limitedParallelism$default(UnlimitedIoScheduler.INSTANCE, systemProp$default, null, 2, null);
    }
    ...
    public void execute(Runnable command) {
        mo2336dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo2336dispatch(CoroutineContext context, Runnable block) {
        f3default.mo2336dispatch(context, block);
    }
