...
public interface ReceiveChannel<E> {
    ...
    Object mo2265receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2266tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo2266tryReceivePtdJZtk();
            if (ChannelResult.m2283isSuccessimpl(result)) {
                return (E) ChannelResult.m2279getOrThrowimpl(result);
            }
            Throwable m2277exceptionOrNullimpl = ChannelResult.m2277exceptionOrNullimpl(result);
            if (m2277exceptionOrNullimpl != null) {
                throw StackTraceRecoveryKt.recoverStackTrace(m2277exceptionOrNullimpl);
            }
            return null;
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L2c:
                ...
                java.lang.Object r4 = r4.m2285unboximpl()
                goto L44
            L37:
                kotlin.ResultKt.throwOnFailure(r1)
                r3 = 1
                r0.label = r3
                java.lang.Object r4 = r4.mo2265receiveCatchingJP2dKIU(r0)
                if (r4 != r2) goto L44
                return r2
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2278getOrNullimpl(r4)
                return r4
            */
