...
final class LazyActorCoroutine<E> extends ActorCoroutine<E> {
    ...
    public final void onSendRegFunction(SelectInstance<?> selectInstance, Object element) {
        onStart();
        super.getOnSend().getRegFunc().mo2351invoke(this, selectInstance, element);
    }
}
