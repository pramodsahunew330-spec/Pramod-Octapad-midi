...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2265receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2265receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2266tryReceivePtdJZtk() {
        return this._channel.mo2266tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2258trySendJP2dKIU(E e) {
        return this._channel.mo2258trySendJP2dKIU(e);
    }
