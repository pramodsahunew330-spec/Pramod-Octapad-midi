...
public class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    public final FileMetadata metadataOrNull(java.nio.file.Path nioPath) {
        ...
        try {
            ...
            Path path = symlinkTarget != null ? Path.Companion.get$default(Path.Companion, symlinkTarget, false, 1, (Object) null) : null;
            ...
            return new FileMetadata(isRegularFile, isDirectory, path, valueOf, zeroToNull, zeroToNull2, l, null, 128, null);
