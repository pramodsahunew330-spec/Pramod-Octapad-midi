...
public final class C0009SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        return new C0009SegmentedByteString(newSegments$iv, newDirectory$iv);
    }

    @Override // okio.ByteString
    public byte internalGet$okio(int pos) {
        SegmentedByteString.checkOffsetAndCount(getDirectory$okio()[getSegments$okio().length - 1], pos, 1L);
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0009SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0009SegmentedByteString $this$commonWrite$iv2 = this;
        ...
        while (pos$iv$iv < endIndex$iv$iv) {
            int segmentOffset$iv$iv = s$iv$iv == 0 ? 0 : $this$commonWrite$iv2.getDirectory$okio()[s$iv$iv - 1];
            int segmentSize$iv$iv = $this$commonWrite$iv2.getDirectory$okio()[s$iv$iv] - segmentOffset$iv$iv;
            int segmentPos$iv$iv = $this$commonWrite$iv2.getDirectory$okio()[$this$commonWrite$iv2.getSegments$okio().length + s$iv$iv];
            ...
            byte[] data$iv = $this$commonWrite$iv2.getSegments$okio()[s$iv$iv];
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0009SegmentedByteString $this$commonRangeEquals$iv = this;
        if (offset >= 0 && offset <= $this$commonRangeEquals$iv.size() - byteCount) {
            ...
            while (pos$iv$iv < endIndex$iv$iv) {
                ...
                C0009SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0009SegmentedByteString $this$commonCopyInto$iv = this;
        ...
        int pos$iv$iv = offset;
        while (pos$iv$iv < endIndex$iv$iv) {
            int segmentOffset$iv$iv = s$iv$iv == 0 ? 0 : $this$commonCopyInto$iv.getDirectory$okio()[s$iv$iv - 1];
            int segmentSize$iv$iv = $this$commonCopyInto$iv.getDirectory$okio()[s$iv$iv] - segmentOffset$iv$iv;
            int segmentPos$iv$iv = $this$commonCopyInto$iv.getDirectory$okio()[$this$commonCopyInto$iv.getSegments$okio().length + s$iv$iv];
            int byteCount$iv$iv = Math.min(endIndex$iv$iv, segmentOffset$iv$iv + segmentSize$iv$iv) - pos$iv$iv;
            int offset$iv$iv = segmentPos$iv$iv + (pos$iv$iv - segmentOffset$iv$iv);
            byte[] data$iv = $this$commonCopyInto$iv.getSegments$okio()[s$iv$iv];
