...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m2388write$default(FileSystem $this, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws IOException {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
            ...
            try {
                ...
                result$iv = writerAction.mo2027invoke(it);
    ...
    public final <T> T m2389read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        ...
        try {
            ...
            t = readerAction.mo2027invoke(it);
            InlineMarker.finallyStart(1);
            if ($this$use$iv != null) {
                try {
                    $this$use$iv.close();
    ...
    public final <T> T m2390write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
        ...
        try {
            BufferedSink it = (BufferedSink) $this$use$iv;
            t = writerAction.mo2027invoke(it);
            InlineMarker.finallyStart(1);
            if ($this$use$iv != null) {
                try {
                    $this$use$iv.close();
