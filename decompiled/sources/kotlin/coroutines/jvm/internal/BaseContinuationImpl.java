    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                m660constructorimpl = Result.m660constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.Companion;
            m660constructorimpl = Result.m660constructorimpl(outcome);
            Object outcome2 = m660constructorimpl;
            $this$resumeWith_u24lambda_u240.releaseIntercepted();
            if (r4 instanceof BaseContinuationImpl) {
                baseContinuationImpl = r4;
                param = outcome2;
            } else {
                r4.resumeWith(outcome2);
                return;
            }
        }
    }
