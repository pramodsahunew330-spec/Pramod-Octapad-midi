...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark mo2217markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2218boximpl(m2210markNowz9LOYto());
    }
    ...
    public long m2210markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2221constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m2209elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2208differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m2207adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2221constructorimpl(LongSaturatedMathKt.m2205saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
