...
public final class DurationKt {
    ...
    private static final long m2203timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m2114timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m2202timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m2113timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX WARN: Removed duplicated region for block: B:268:0x00bc A[LOOP:1: B:252:0x007b->B:268:0x00bc, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:353:0x0277 A[LOOP:4: B:337:0x024c->B:353:0x0277, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:416:0x00d7 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:417:0x0342 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:422:0x0303 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:430:0x0280 A[SYNTHETIC] */
    /*
    ...
    */
    ...
    private static final String substringWhile(String $this$substringWhile, int startIndex, Function1<? super Character, Boolean> function1) {
        int i$iv = startIndex;
        while (i$iv < $this$substringWhile.length() && function1.mo2027invoke(Character.valueOf($this$substringWhile.charAt(i$iv))).booleanValue()) {
            i$iv++;
        }
    ...
    private static final int skipWhile(String $this$skipWhile, int startIndex, Function1<? super Character, Boolean> function1) {
        int i = startIndex;
        while (i < $this$skipWhile.length() && function1.mo2027invoke(Character.valueOf($this$skipWhile.charAt(i))).booleanValue()) {
            i++;
        }
        return i;
    }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m2076constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m2076constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m2076constructorimpl((normalValue << 1) + unitDiscriminator);
    }
