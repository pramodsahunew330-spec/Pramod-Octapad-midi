...
public interface TimeMark {
    ...
    TimeMark mo2234minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2235plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2215plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m2214minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo2235plusLRDsOJo(Duration.m2129unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m2109isNegativeimpl($this.mo2060elapsedNowUwyO8pc());
        }
