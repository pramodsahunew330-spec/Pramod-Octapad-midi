...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo2060elapsedNowUwyO8pc() {
            return Duration.m2111minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.ComparableTimeMark, kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark mo2235plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m2112plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo2062minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m2081equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m2108isInfiniteimpl(this.offset)) {
                return Duration.Companion.m2179getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m2111minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m2081equalsimpl0(startedAtDiff, Duration.m2129unaryMinusUwyO8pc(offsetDiff)) ? Duration.Companion.m2179getZEROUwyO8pc() : Duration.m2112plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m2081equalsimpl0(mo2062minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m2179getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m2104hashCodeimpl(Duration.m2112plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m2125toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }
    ...
    public ComparableTimeMark mo2217markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m2179getZEROUwyO8pc(), null);
    }
}
