...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo2234minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo2062minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo2235plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m2071minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo2235plusLRDsOJo(Duration.m2129unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m2075compareToLRDsOJo($this.mo2062minusUwyO8pc(other), Duration.Companion.m2179getZEROUwyO8pc());
        }
    }
}
