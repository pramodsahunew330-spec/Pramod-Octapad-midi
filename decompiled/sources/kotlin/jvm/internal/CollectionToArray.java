...
public final class CollectionToArray {
    ...
    private static final Object[] toArrayImpl(Collection<?> collection, Function0<Object[]> function0, Function1<? super Integer, Object[]> function1, Function2<? super Object[], ? super Integer, Object[]> function2) {
        ...
        Object[] mo2027invoke = function1.mo2027invoke(Integer.valueOf(size));
        int i = 0;
        while (true) {
            int i2 = i + 1;
            mo2027invoke[i] = iter.next();
            if (i2 >= mo2027invoke.length) {
                if (!iter.hasNext()) {
                    return mo2027invoke;
                }
                ...
                Object[] copyOf = Arrays.copyOf((Object[]) mo2027invoke, newSize);
                Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
                mo2027invoke = copyOf;
                i = i2;
            } else if (!iter.hasNext()) {
                return function2.mo2029invoke(mo2027invoke, Integer.valueOf(i2));
            } else {
                i = i2;
            }
        }
