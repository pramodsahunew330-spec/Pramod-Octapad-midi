...
public class FunctionReference extends CallableReference implements FunctionBase, KFunction {
    ...
    public KFunction mo1918getReflected() {
        return (KFunction) super.mo1918getReflected();
    }
    ...
    public boolean isInline() {
        return mo1918getReflected().isInline();
    }

    @Override // kotlin.reflect.KFunction
    public boolean isExternal() {
        return mo1918getReflected().isExternal();
    }

    @Override // kotlin.reflect.KFunction
    public boolean isOperator() {
        return mo1918getReflected().isOperator();
    }

    @Override // kotlin.reflect.KFunction
    public boolean isInfix() {
        return mo1918getReflected().isInfix();
    }
