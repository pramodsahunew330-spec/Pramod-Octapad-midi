...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, ClosedFloatingPointRange<T> range) {
        ...
        if (!range.isEmpty()) {
            return (!range.lessThanOrEquals(t, range.mo1947getStart()) || range.lessThanOrEquals(range.mo1947getStart(), t)) ? (!range.lessThanOrEquals(range.mo1946getEndInclusive(), t) || range.lessThanOrEquals(t, range.mo1946getEndInclusive())) ? t : range.mo1946getEndInclusive() : range.mo1947getStart();
        }
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, ClosedRange<T> range) {
        ...
        return t.compareTo(range.mo1947getStart()) < 0 ? range.mo1947getStart() : t.compareTo(range.mo1946getEndInclusive()) > 0 ? range.mo1946getEndInclusive() : t;
    }
    ...
    public static final int coerceIn(int $this$coerceIn, ClosedRange<Integer> range) {
        ...
        return $this$coerceIn < range.mo1947getStart().intValue() ? range.mo1947getStart().intValue() : $this$coerceIn > range.mo1946getEndInclusive().intValue() ? range.mo1946getEndInclusive().intValue() : $this$coerceIn;
    }
    ...
    public static final long coerceIn(long $this$coerceIn, ClosedRange<Long> range) {
        ...
        return $this$coerceIn < range.mo1947getStart().longValue() ? range.mo1947getStart().longValue() : $this$coerceIn > range.mo1946getEndInclusive().longValue() ? range.mo1946getEndInclusive().longValue() : $this$coerceIn;
    }
}
