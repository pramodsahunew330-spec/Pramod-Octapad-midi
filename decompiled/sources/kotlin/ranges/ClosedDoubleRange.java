...
final class ClosedDoubleRange implements ClosedFloatingPointRange<Double> {
    ...
    public int hashCode() {
        ...
        return (Double.doubleToLongBits(this._start) * 31) + Double.doubleToLongBits(this._endInclusive);
    }
