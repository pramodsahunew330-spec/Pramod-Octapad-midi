...
class MapsKt___MapsKt extends MapsKt___MapsJvmKt {
    private static final <K, V, R> R firstNotNullOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        while (true) {
            ...
            r = transform.mo2027invoke(it.next());
            if (r != null) {
                break;
            }
        }
    ...
    private static final <K, V, R> R firstNotNullOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        for (Map.Entry element : map.entrySet()) {
            R mo2027invoke = transform.mo2027invoke(element);
            if (mo2027invoke != null) {
                return mo2027invoke;
            }
        }
        return null;
    ...
    public static final <K, V, R> List<R> flatMap(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Iterable<? extends R>> transform) {
        ...
        for (Map.Entry element$iv : map.entrySet()) {
            Iterable list$iv = transform.mo2027invoke(element$iv);
    ...
    public static final <K, V, R> List<R> flatMapSequence(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Sequence<? extends R>> transform) {
        ...
        Collection destination$iv = new ArrayList();
        for (Map.Entry element$iv : map.entrySet()) {
            Sequence list$iv = transform.mo2027invoke(element$iv);
            CollectionsKt.addAll(destination$iv, list$iv);
        }
        return (List) destination$iv;
    }
    ...
    public static final <K, V, R, C extends Collection<? super R>> C flatMapTo(Map<? extends K, ? extends V> map, C destination, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Iterable<? extends R>> transform) {
        ...
        Intrinsics.checkNotNullParameter(transform, "transform");
        for (Map.Entry element : map.entrySet()) {
            Iterable list = transform.mo2027invoke(element);
    ...
    public static final <K, V, R, C extends Collection<? super R>> C flatMapSequenceTo(Map<? extends K, ? extends V> map, C destination, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Sequence<? extends R>> transform) {
        ...
        Intrinsics.checkNotNullParameter(transform, "transform");
        for (Map.Entry element : map.entrySet()) {
            Sequence list = transform.mo2027invoke(element);
            CollectionsKt.addAll(destination, list);
        }
        return destination;
    }
    ...
    public static final <K, V, R> List<R> map(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        for (Map.Entry item$iv : map.entrySet()) {
            destination$iv.add(transform.mo2027invoke(item$iv));
        }
        return (List) destination$iv;
    }
    ...
    public static final <K, V, R> List<R> mapNotNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        for (Map.Entry element$iv$iv : map.entrySet()) {
            R mo2027invoke = transform.mo2027invoke(element$iv$iv);
            if (mo2027invoke != null) {
                destination$iv.add(mo2027invoke);
            }
        }
        return (List) destination$iv;
    }
    ...
    public static final <K, V, R, C extends Collection<? super R>> C mapNotNullTo(Map<? extends K, ? extends V> map, C destination, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        Intrinsics.checkNotNullParameter(transform, "transform");
        for (Map.Entry element$iv : map.entrySet()) {
            R mo2027invoke = transform.mo2027invoke(element$iv);
            if (mo2027invoke != null) {
                destination.add(mo2027invoke);
            }
        }
        return destination;
    }
    ...
    public static final <K, V, R, C extends Collection<? super R>> C mapTo(Map<? extends K, ? extends V> map, C destination, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        for (Map.Entry item : map.entrySet()) {
            destination.add(transform.mo2027invoke(item));
        }
        return destination;
    }
    ...
    public static final <K, V> boolean all(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        ...
        for (Map.Entry element : map.entrySet()) {
            if (!predicate.mo2027invoke(element).booleanValue()) {
                return false;
            }
        }
        return true;
    ...
    private static final <K, V, R extends Comparable<? super R>> Map.Entry<K, V> maxByOrThrow(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> selector) {
        ...
        Comparable maxValue$iv = selector.mo2027invoke(maxElem$iv);
        do {
            Object e$iv = (Object) iterator$iv.next();
            R mo2027invoke = selector.mo2027invoke(e$iv);
            if (maxValue$iv.compareTo(mo2027invoke) < 0) {
                maxElem$iv = (Object) e$iv;
                maxValue$iv = mo2027invoke;
            }
    ...
    private static final <K, V> double maxOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Double> selector) {
        ...
        if (it.hasNext()) {
            double doubleValue = selector.mo2027invoke((Object) it.next()).doubleValue();
            while (it.hasNext()) {
                doubleValue = Math.max(doubleValue, selector.mo2027invoke((Object) it.next()).doubleValue());
            }
            return doubleValue;
        }
        throw new NoSuchElementException();
    ...
    private static final <K, V> float m1141maxOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
            float floatValue = selector.mo2027invoke((Object) it.next()).floatValue();
            while (it.hasNext()) {
                floatValue = Math.max(floatValue, selector.mo2027invoke((Object) it.next()).floatValue());
            }
            return floatValue;
        }
        throw new NoSuchElementException();
    ...
    /* renamed from: maxOf  reason: collision with other method in class */
    private static final <K, V, R extends Comparable<? super R>> R m1142maxOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
            R mo2027invoke = selector.mo2027invoke((Object) it.next());
            while (it.hasNext()) {
                R mo2027invoke2 = selector.mo2027invoke((Object) it.next());
                if (mo2027invoke.compareTo(mo2027invoke2) < 0) {
                    mo2027invoke = mo2027invoke2;
                }
            }
            return mo2027invoke;
        }
    ...
    private static final <K, V> Double m1143maxOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Double> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (!it.hasNext()) {
    ...
    /* renamed from: maxOfOrNull  reason: collision with other method in class */
    private static final <K, V> Float m1144maxOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (!it.hasNext()) {
    ...
    private static final <K, V, R> R maxOfWith(Map<? extends K, ? extends V> map, Comparator<? super R> comparator, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> selector) {
        ...
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
            Object obj = (R) selector.mo2027invoke((Object) it.next());
            while (it.hasNext()) {
                R mo2027invoke = selector.mo2027invoke((Object) it.next());
                if (comparator.compare(obj, mo2027invoke) < 0) {
                    obj = mo2027invoke;
                }
            }
            return (R) obj;
    ...
    private static final <K, V, R extends Comparable<? super R>> Map.Entry<K, V> minByOrThrow(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> selector) {
        ...
        Comparable minValue$iv = selector.mo2027invoke(minElem$iv);
        do {
            Object e$iv = (Object) iterator$iv.next();
            R mo2027invoke = selector.mo2027invoke(e$iv);
            if (minValue$iv.compareTo(mo2027invoke) > 0) {
                minElem$iv = (Object) e$iv;
                minValue$iv = mo2027invoke;
            }
        } while (iterator$iv.hasNext());
        return (Map.Entry) minElem$iv;
    }
    ...
    private static final <K, V> double minOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Double> selector) {
        ...
        if (it.hasNext()) {
            double doubleValue = selector.mo2027invoke((Object) it.next()).doubleValue();
            while (it.hasNext()) {
                doubleValue = Math.min(doubleValue, selector.mo2027invoke((Object) it.next()).doubleValue());
            }
            return doubleValue;
        }
        throw new NoSuchElementException();
    ...
    private static final <K, V> float m1145minOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
            float floatValue = selector.mo2027invoke((Object) it.next()).floatValue();
            while (it.hasNext()) {
                floatValue = Math.min(floatValue, selector.mo2027invoke((Object) it.next()).floatValue());
            }
            return floatValue;
        }
        throw new NoSuchElementException();
    ...
    /* renamed from: minOf  reason: collision with other method in class */
    private static final <K, V, R extends Comparable<? super R>> R m1146minOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
    ...
    private static final <K, V> Double m1147minOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Double> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (!it.hasNext()) {
    ...
    /* renamed from: minOfOrNull  reason: collision with other method in class */
    private static final <K, V> Float m1148minOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> selector) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator<T> it = map.entrySet().iterator();
        if (!it.hasNext()) {
    ...
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEachIndexed(M m, Function2<? super Integer, ? super Map.Entry<? extends K, ? extends V>, Unit> action) {
        ...
        for (Object item$iv : $this$forEachIndexed$iv) {
            ...
            action.mo2029invoke(Integer.valueOf(index$iv), item$iv);
            index$iv = index$iv2;
        }
        return m;
    }
