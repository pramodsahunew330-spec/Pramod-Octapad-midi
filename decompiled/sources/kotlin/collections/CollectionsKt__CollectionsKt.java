...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    private static final <T> List<T> List(int size, Function1<? super Integer, ? extends T> init) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(init.mo2027invoke(Integer.valueOf(i)));
        }
        return arrayList;
    }
    ...
    private static final <T> List<T> MutableList(int size, Function1<? super Integer, ? extends T> init) {
        ...
        for (int i = 0; i < size; i++) {
            int index = i;
            list.add(init.mo2027invoke(Integer.valueOf(index)));
        }
        return list;
    }
    ...
    private static final <E> List<E> buildList(Function1<? super List<E>, Unit> builderAction) {
        ...
        builderAction.mo2027invoke(createListBuilder);
    ...
    public static final <T> List<T> shuffled(Iterable<? extends T> iterable, Random random) {
        ...
        List $this$shuffled_u24lambda_u245 = CollectionsKt.toMutableList(iterable);
    ...
    public static final <T> int binarySearch(List<? extends T> list, int fromIndex, int toIndex, Function1<? super T, Integer> comparison) {
        ...
        while (low <= high) {
            int mid = (low + high) >>> 1;
            Object midVal = (T) list.get(mid);
            int cmp = comparison.mo2027invoke(midVal).intValue();
            if (cmp < 0) {
                low = mid + 1;
            } else if (cmp > 0) {
                high = mid - 1;
    ...
    public static final <T> T[] collectionToArrayCommonImpl(Collection<?> collection, T[] array) {
        ...
        int index2 = collection.size();
        return (T[]) CollectionsKt.terminateCollectionToArray(index2, destination);
    }
}
