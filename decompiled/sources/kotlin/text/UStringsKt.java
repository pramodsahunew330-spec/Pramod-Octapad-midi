...
public final class UStringsKt {
    ...
    public static final String m2056toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m2058toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m2057toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m2055toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m728unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m991unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m807unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m886unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m807unboximpl = uIntOrNull.m807unboximpl();
            compare = Integer.compare(m807unboximpl ^ Integer.MIN_VALUE, UInt.m755constructorimpl(255) ^ Integer.MIN_VALUE);
            if (compare <= 0) {
                return UByte.m672boximpl(UByte.m678constructorimpl((byte) m807unboximpl));
            }
            return null;
        }
        return null;
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m807unboximpl = uIntOrNull.m807unboximpl();
            compare = Integer.compare(m807unboximpl ^ Integer.MIN_VALUE, UInt.m755constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE);
            if (compare <= 0) {
                return UShort.m935boximpl(UShort.m941constructorimpl((short) m807unboximpl));
            }
            return null;
        }
        return null;
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m755constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m755constructorimpl(result * uradix);
            result = UInt.m755constructorimpl(UInt.m755constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m749boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m834constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m834constructorimpl(result * uradix);
            result = ULong.m834constructorimpl(ULong.m834constructorimpl(UInt.m755constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m828boximpl(result);
    }
}
