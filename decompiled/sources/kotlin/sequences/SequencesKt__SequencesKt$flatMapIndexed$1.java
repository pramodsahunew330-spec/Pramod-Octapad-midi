...
public final class SequencesKt__SequencesKt$flatMapIndexed$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: invoke */
    public final Object mo2029invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        while (it.hasNext()) {
            ...
            Object result = function2.mo2029invoke(Boxing.boxInt(index), element);
            ...
            if ($this$sequence.yieldAll((Iterator) sequencesKt__SequencesKt$flatMapIndexed$1.$iterator.mo2027invoke(result), sequencesKt__SequencesKt$flatMapIndexed$1) == coroutine_suspended) {
