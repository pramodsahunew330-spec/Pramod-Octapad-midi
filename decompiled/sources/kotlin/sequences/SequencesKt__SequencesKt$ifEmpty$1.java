...
final class SequencesKt__SequencesKt$ifEmpty$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: invoke */
    public final Object mo2029invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (iterator.hasNext()) {
                    ...
                    this.label = 2;
                    if ($this$sequence.yieldAll((Sequence) this.$defaultValue.mo2400invoke(), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
                break;
