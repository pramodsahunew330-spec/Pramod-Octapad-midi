...
public class EmojiCompatInitializer implements Initializer<Boolean> {
    ...
    /* renamed from: create */
    public Boolean mo305create(Context context) {
    ...
    public static class BackgroundDefaultLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void load(final EmojiCompat.MetadataRepoLoaderCallback loaderCallback) {
            ...
            executor.execute(new Runnable() { // from class: androidx.emoji2.text.EmojiCompatInitializer$BackgroundDefaultLoader$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    EmojiCompatInitializer.BackgroundDefaultLoader.this.m252x5cc8028a(loaderCallback, executor);
                }
            });
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: doLoad */
        public void m252x5cc8028a(final EmojiCompat.MetadataRepoLoaderCallback loaderCallback, final ThreadPoolExecutor executor) {
            try {
