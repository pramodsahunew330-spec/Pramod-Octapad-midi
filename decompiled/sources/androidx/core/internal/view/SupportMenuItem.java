...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo41setActionView(int i);

    @Override // android.view.MenuItem
    /* renamed from: setActionView */
    MenuItem mo42setActionView(View view);
    ...
    SupportMenuItem mo43setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo44setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo45setTooltipText(CharSequence charSequence);
