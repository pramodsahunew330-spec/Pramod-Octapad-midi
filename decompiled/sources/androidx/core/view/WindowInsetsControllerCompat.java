...
public final class WindowInsetsControllerCompat {
    ...
    public static class Impl30 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        void show(int types) {
            if (this.mWindow != null && (types & 8) != 0 && Build.VERSION.SDK_INT < 33) {
                InputMethodManager imm = (InputMethodManager) this.mWindow.getContext().getSystemService("input_method");
                imm.isActive();
            }
        ...
        void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener listener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener fwListener = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda0
                ...
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    WindowInsetsControllerCompat.Impl30.this.m116xe96d8c51(listener, windowInsetsController, i);
                }
            };
        ...
        public /* synthetic */ void m116xe96d8c51(OnControllableInsetsChangedListener listener, WindowInsetsController controller, int typeMask) {
