...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    public /* synthetic */ void m119lambda$new$0$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public /* synthetic */ void m120lambda$new$1$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attrs) {
        ...
        this.mDelayedHide = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ContentLoadingProgressBar.this.m119lambda$new$0$androidxcorewidgetContentLoadingProgressBar();
            }
        };
        this.mDelayedShow = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ContentLoadingProgressBar.this.m120lambda$new$1$androidxcorewidgetContentLoadingProgressBar();
            }
        };
    }
