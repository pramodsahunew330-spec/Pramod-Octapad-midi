...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    private int scrollBy(int verticalScrollDistance, int x, int touchType, boolean isSourceMouseOrKeyboard) {
        ...
        int verticalScrollDistance3 = verticalScrollDistance2 - this.mScrollConsumed[1];
        int newScrollY = initialScrollY + verticalScrollDistance3;
        if (newScrollY < 0) {
            if (canOverscroll) {
                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, (-verticalScrollDistance3) / getHeight(), x / getWidth());
                if (!this.mEdgeGlowBottom.isFinished()) {
                    this.mEdgeGlowBottom.onRelease();
                }
            }
        } else if (newScrollY > scrollRangeY && canOverscroll) {
            EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, verticalScrollDistance3 / getHeight(), 1.0f - (x / getWidth()));
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.core.widget.NestedScrollView.SavedState.1
            ...
            public SavedState mo121createFromParcel(Parcel in) {
            ...
            public SavedState[] mo122newArray(int size) {
