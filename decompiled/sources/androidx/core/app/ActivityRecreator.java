...
public final class ActivityRecreator {
    ...
    private static Method getRequestRelaunchActivityMethod(Class<?> activityThreadClass2) {
        ...
        try {
            ...
            Method relaunch = activityThreadClass2.getDeclaredMethod("requestRelaunchActivity", IBinder.class, List.class, List.class, Integer.TYPE, cls, Configuration.class, Configuration.class, cls, cls);
