...
public class NotificationCompat {
        ...
        public static final class Message {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    frameworkMessage = Api28Impl.createMessage(text, timestamp, person2);
                } else {
                    ...
                    frameworkMessage = Api24Impl.createMessage(text2, timestamp2, charSequence);
                }
    ...
    public static class CallStyle extends Style {
        ...
        public void addCompatExtras(Bundle extras) {
            ...
            if (this.mPerson != null) {
                if (Build.VERSION.SDK_INT >= 28) {
                    extras.putParcelable(NotificationCompat.EXTRA_CALL_PERSON, this.mPerson.toAndroidPerson());
                } else {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m83clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m84clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle b) {
            ...
            return new UnreadConversation(messages, remoteInputCompat, onReply, onRead, participants, b.getLong("timestamp"));
        }
