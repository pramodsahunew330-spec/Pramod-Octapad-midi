...
public class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder b) {
        ...
        Api16Impl.setPriority(Api16Impl.setUsesChronometer(Api16Impl.setSubText(this.mBuilder, b.mSubText), b.mUseChronometer), b.mPriority);
    ...
    protected Notification buildInternal() {
        ...
        Notification notification2 = Api16Impl.build(this.mBuilder);
        ...
        if (this.mGroupAlertBehavior != 0) {
            if (Api20Impl.getGroup(notification2) != null && (notification2.flags & 512) != 0 && this.mGroupAlertBehavior == 2) {
                removeSoundAndVibration(notification2);
            }
            if (Api20Impl.getGroup(notification2) != null && (notification2.flags & 512) == 0 && this.mGroupAlertBehavior == 1) {
                removeSoundAndVibration(notification2);
            }
        }
