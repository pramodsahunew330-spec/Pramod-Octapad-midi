...
public final class LruCacheKt {
    public static /* synthetic */ LruCache lruCache$default(int maxSize, Function2 sizeOf, Function1 create, Function4 onEntryRemoved, int i, Object obj) {
        if ((i & 2) != 0) {
            Function2 sizeOf2 = LruCacheKt$lruCache$1.INSTANCE;
            sizeOf = sizeOf2;
        }
        if ((i & 4) != 0) {
            Function1 create2 = LruCacheKt$lruCache$2.INSTANCE;
            create = create2;
        }
        if ((i & 8) != 0) {
            Function4 onEntryRemoved2 = LruCacheKt$lruCache$3.INSTANCE;
