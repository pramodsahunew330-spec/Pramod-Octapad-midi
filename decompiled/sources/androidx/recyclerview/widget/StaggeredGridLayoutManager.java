...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            if (layoutState.hasMore(state)) {
                ...
                if (spanIndex == -1) {
                    ...
                    boolean z6 = r10 == true ? 1 : 0;
                    z2 = z5;
                } else {
                    z2 = z4;
                }
                boolean assignSpan = z2;
                if (assignSpan) {
                    if (lp.mFullSpan) {
                ...
                measureChildWithDecorationsAndMargin(view, lp, z4);
                if (layoutState.mLayoutDirection == r10) {
                    if (lp.mFullSpan) {
                ...
                if (lp.mFullSpan && layoutState.mItemDirection == -1) {
                    if (assignSpan) {
                        ...
                        if (layoutState.mLayoutDirection == r10) {
                            ...
                            boolean z7 = r10 == true ? 1 : 0;
                            boolean z8 = r10 == true ? 1 : 0;
                            hasInvalidGap = (hasInvalidGap2 ? 1 : 0) ^ z7;
                        }
                        if (hasInvalidGap) {
        ...
        return diff > 0 ? Math.min(layoutState.mAvailable, diff) : z;
    }
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() { // from class: androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem.1
                ...
                public FullSpanItem mo311createFromParcel(Parcel in) {
                ...
                public FullSpanItem[] mo312newArray(int size) {
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.recyclerview.widget.StaggeredGridLayoutManager.SavedState.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo313createFromParcel(Parcel in) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo314newArray(int size) {
