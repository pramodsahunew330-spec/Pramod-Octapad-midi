...
public final class ResourceManagerInternal {
    ...
    private Drawable createDrawableIfNeeded(Context context, int resId) {
        ...
        Drawable dr2 = this.mHooks == null ? null : this.mHooks.createDrawableFor(this, context, resId);
        if (dr2 != null) {
    ...
    private Drawable tintDrawable(Context context, int resId, boolean failIfNotKnown, Drawable drawable) {
        ...
        if (tintList == null) {
            if (this.mHooks == null || !this.mHooks.tintDrawable(context, resId, drawable)) {
