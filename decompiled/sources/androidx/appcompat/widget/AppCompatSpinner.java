    ...
    */
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.appcompat.widget.AppCompatSpinner.SavedState.1
            ...
            public SavedState mo54createFromParcel(Parcel in) {
            ...
            public SavedState[] mo55newArray(int size) {
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show(int textDirection, int textAlignment) {
            ...
            if (this.mPrompt != null) {
                builder.mo434setTitle(this.mPrompt);
            }
            this.mPopup = builder.mo431setSingleChoiceItems(this.mListAdapter, AppCompatSpinner.this.getSelectedItemPosition(), this).create();
