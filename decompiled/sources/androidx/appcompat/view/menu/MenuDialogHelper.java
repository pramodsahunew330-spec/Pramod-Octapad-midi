...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void show(IBinder windowToken) {
        ...
        builder.mo402setAdapter(this.mPresenter.getAdapter(), this);
        View headerView = menu.getHeaderView();
        if (headerView != null) {
            builder.mo405setCustomTitle(headerView);
        } else {
            builder.mo407setIcon(menu.getHeaderIcon()).mo434setTitle(menu.getHeaderTitle());
        }
        builder.mo425setOnKeyListener(this);
