...
public class MenuAdapter extends BaseAdapter {
    ...
    public MenuItemImpl mo40getItem(int position) {
        ArrayList<MenuItemImpl> items = this.mOverflowOnly ? this.mAdapterMenu.getNonActionItems() : this.mAdapterMenu.getVisibleItems();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int currGroupId = mo40getItem(position).getGroupId();
        int prevGroupId = position + (-1) >= 0 ? mo40getItem(position - 1).getGroupId() : currGroupId;
        ...
        itemView.initialize(mo40getItem(position), 0);
        return convertView;
    }
