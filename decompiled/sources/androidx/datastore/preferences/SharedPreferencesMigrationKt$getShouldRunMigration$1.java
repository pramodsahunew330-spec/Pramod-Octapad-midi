...
final class SharedPreferencesMigrationKt$getShouldRunMigration$1 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
    ...
    public final Object mo2029invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    Preferences.Key it2 = (Preferences.Key) item$iv$iv;
