...
class UnknownFieldSetLiteSchema extends UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> {
    ...
    public UnknownFieldSetLite mo245newBuilder() {
    ...
    public UnknownFieldSetLite mo244getFromMessage(Object message) {
    ...
    public UnknownFieldSetLite mo243getBuilderFromMessage(Object message) {
        UnknownFieldSetLite unknownFields = mo244getFromMessage(message);
    ...
    public void makeImmutable(Object message) {
        mo244getFromMessage(message).makeImmutable();
    }
