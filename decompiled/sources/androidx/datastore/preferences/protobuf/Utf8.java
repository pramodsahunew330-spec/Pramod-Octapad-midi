...
public final class Utf8 {
    ...
    static final class SafeProcessor extends Processor {
        ...
        */
        int encodeUtf8(java.lang.String r11, byte[] r12, int r13, int r14) {
            /*
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        String decodeUtf8(byte[] bytes, int index, int size) throws InvalidProtocolBufferException {
            ...
            if (s.indexOf(okio.Utf8.REPLACEMENT_CODE_POINT) < 0) {
                return s;
            }
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        java.lang.String decodeUtf8Direct(java.nio.ByteBuffer r22, int r23, int r24) throws androidx.datastore.preferences.protobuf.InvalidProtocolBufferException {
            /*
                Method dump skipped, instructions count: 256
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.Utf8.UnsafeProcessor.decodeUtf8Direct(java.nio.ByteBuffer, int, int):java.lang.String");
        }
        ...
        void encodeUtf8Direct(String in, ByteBuffer out) {
            ...
            if (inIx == inLimit) {
                Java8Compatibility.position(out, (int) (outIx2 - address));
                return;
            }
            while (inIx < inLimit) {
