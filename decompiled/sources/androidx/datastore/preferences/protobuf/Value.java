...
public final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
    ...
    public void mergeStructValue(Struct value) {
        ...
        if (this.kindCase_ == 5 && this.kind_ != Struct.getDefaultInstance()) {
            this.kind_ = Struct.newBuilder((Struct) this.kind_).mergeFrom((Struct.Builder) value).mo220buildPartial();
        } else {
            this.kind_ = value;
        }
        this.kindCase_ = 5;
    ...
    public void mergeListValue(ListValue value) {
        ...
        if (this.kindCase_ == 6 && this.kind_ != ListValue.getDefaultInstance()) {
            this.kind_ = ListValue.newBuilder((ListValue) this.kind_).mergeFrom((ListValue.Builder) value).mo220buildPartial();
        } else {
            this.kind_ = value;
        }
        this.kindCase_ = 6;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
        ...
        public Builder setStructValue(Struct.Builder builderForValue) {
            copyOnWrite();
            ((Value) this.instance).setStructValue(builderForValue.mo209build());
            return this;
        }
        ...
        public Builder setListValue(ListValue.Builder builderForValue) {
            copyOnWrite();
            ((Value) this.instance).setListValue(builderForValue.mo209build());
            return this;
        }
