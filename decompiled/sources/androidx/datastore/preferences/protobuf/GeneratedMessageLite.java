...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public final MessageType mo214getDefaultInstanceForType() {
        return (MessageType) dynamicMethod(MethodToInvoke.GET_DEFAULT_INSTANCE);
    }

    @Override // androidx.datastore.preferences.protobuf.MessageLite
    /* renamed from: newBuilderForType */
    public final BuilderType mo207newBuilderForType() {
    ...
    public final BuilderType mo208toBuilder() {
    ...
    public static <T extends GeneratedMessageLite<?, ?>> T getDefaultInstance(Class<T> clazz) {
        ...
        if (generatedMessageLite == null) {
            generatedMessageLite = (T) ((GeneratedMessageLite) UnsafeUtil.allocateInstance(clazz)).mo214getDefaultInstanceForType();
            if (generatedMessageLite == null) {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        /* renamed from: clear */
        public final BuilderType mo211clear() {
        ...
        public BuilderType mo213clone() {
            BuilderType builder = (BuilderType) mo214getDefaultInstanceForType().mo207newBuilderForType();
            builder.instance = mo220buildPartial();
            return builder;
        }

        @Override // androidx.datastore.preferences.protobuf.MessageLite.Builder
        /* renamed from: buildPartial */
        public MessageType mo220buildPartial() {
            if (!this.instance.isMutable()) {
        ...
        @Override // androidx.datastore.preferences.protobuf.MessageLite.Builder
        /* renamed from: build */
        public final MessageType mo209build() {
            MessageType result = mo220buildPartial();
        ...
        public BuilderType mergeFrom(MessageType message) {
            if (mo214getDefaultInstanceForType().equals(message)) {
                return this;
            }
            copyOnWrite();
        ...
        @Override // androidx.datastore.preferences.protobuf.MessageLiteOrBuilder
        /* renamed from: getDefaultInstanceForType */
        public MessageType mo214getDefaultInstanceForType() {
            return this.defaultInstance;
        }

        @Override // androidx.datastore.preferences.protobuf.AbstractMessageLite.Builder, androidx.datastore.preferences.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom  reason: collision with other method in class */
        public BuilderType mo217mergeFrom(byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            copyOnWrite();
            try {
        ...
        @Override // androidx.datastore.preferences.protobuf.AbstractMessageLite.Builder, androidx.datastore.preferences.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom  reason: collision with other method in class */
        public BuilderType mo216mergeFrom(byte[] input, int offset, int length) throws InvalidProtocolBufferException {
            return mo217mergeFrom(input, offset, length, ExtensionRegistryLite.getEmptyRegistry());
        }

        @Override // androidx.datastore.preferences.protobuf.AbstractMessageLite.Builder, androidx.datastore.preferences.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom  reason: collision with other method in class */
        public BuilderType mo215mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            copyOnWrite();
            try {
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        /* renamed from: getDefaultInstanceForType */
        public /* bridge */ /* synthetic */ MessageLite mo214getDefaultInstanceForType() {
            return super.mo214getDefaultInstanceForType();
        }

        @Override // androidx.datastore.preferences.protobuf.GeneratedMessageLite, androidx.datastore.preferences.protobuf.MessageLite
        /* renamed from: newBuilderForType */
        public /* bridge */ /* synthetic */ MessageLite.Builder mo207newBuilderForType() {
            return super.mo207newBuilderForType();
        }

        @Override // androidx.datastore.preferences.protobuf.GeneratedMessageLite, androidx.datastore.preferences.protobuf.MessageLite
        /* renamed from: toBuilder */
        public /* bridge */ /* synthetic */ MessageLite.Builder mo208toBuilder() {
            return super.mo208toBuilder();
        }

        protected final void mergeExtensionFields(final MessageType other) {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m203clone();
            }
            ...
            if (packed) {
                ...
                if (extension.descriptor.getLiteType() == WireFormat.FieldType.ENUM) {
                    while (input.getBytesUntilLimit() > 0) {
                        Object value2 = extension.descriptor.getEnumType().mo242findValueByNumber(input.readEnum());
                        if (value2 == null) {
                            return z;
                        }
            ...
            switch (extension.descriptor.getLiteJavaType()) {
                case MESSAGE:
                    ...
                    if (!extension.descriptor.isRepeated() && (existingValue = (MessageLite) this.extensions.getField(extension.descriptor)) != null) {
                        subBuilder = existingValue.mo208toBuilder();
                    }
                    if (subBuilder == null) {
                        subBuilder = extension.getMessageDefaultInstance().mo207newBuilderForType();
                    }
                    ...
                    value = subBuilder.mo209build();
                    break;
                case ENUM:
                    int rawValue = input.readEnum();
                    value = extension.descriptor.getEnumType().mo242findValueByNumber(rawValue);
                    if (value != null) {
                        break;
                    } else {
        ...
        private void mergeMessageSetExtensionFromBytes(ByteString rawBytes, ExtensionRegistryLite extensionRegistry, GeneratedExtension<?, ?> extension) throws IOException {
            ...
            subBuilder.mo143mergeFrom(rawBytes, extensionRegistry);
            MessageLite value = subBuilder.mo209build();
        ...
        private void verifyExtensionContainingType(final GeneratedExtension<MessageType, ?> extension) {
            if (extension.getContainingTypeDefaultInstance() != mo214getDefaultInstanceForType()) {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        protected void copyOnWriteInternal() {
            ...
            if (((ExtendableMessage) this.instance).extensions != FieldSet.emptySet()) {
                ((ExtendableMessage) this.instance).extensions = ((ExtendableMessage) this.instance).extensions.m203clone();
            }
        }
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            if (extensions.isImmutable()) {
                FieldSet<ExtensionDescriptor> extensions2 = extensions.m203clone();
        ...
        /* renamed from: buildPartial */
        public final MessageType mo220buildPartial() {
            if (!((ExtendableMessage) this.instance).isMutable()) {
                return (MessageType) this.instance;
            }
            ((ExtendableMessage) this.instance).extensions.makeImmutable();
            return (MessageType) super.mo220buildPartial();
        }
    ...
    public static class GeneratedExtension<ContainingType extends MessageLite, Type> extends ExtensionLite<ContainingType, Type> {
        ...
        Object singularFromFieldSetType(Object value) {
            if (this.descriptor.getLiteJavaType() == WireFormat.JavaType.ENUM) {
                return this.descriptor.enumTypeMap.mo242findValueByNumber(((Integer) value).intValue());
            }
            return value;
        }
    ...
    protected static final class SerializedForm implements Serializable {
        ...
        protected Object readResolve() throws ObjectStreamException {
            try {
                ...
                return defaultInstance.mo207newBuilderForType().mo149mergeFrom(this.asBytes).mo220buildPartial();
            } catch (InvalidProtocolBufferException e) {
    ...
    public static Internal.IntList mutableCopy(Internal.IntList list) {
        int size = list.size();
        return list.mo237mutableCopyWithCapacity(size == 0 ? 10 : size * 2);
    }
    ...
    protected static class DefaultInstanceBasedParser<T extends GeneratedMessageLite<T, ?>> extends AbstractParser<T> {
        ...
        public T mo219parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        /* renamed from: parsePartialFrom */
        public T mo218parsePartialFrom(byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T defaultInstance, byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        if (length == 0) {
