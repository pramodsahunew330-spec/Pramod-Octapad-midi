...
public final class RopeByteString extends ByteString {
        ...
        return new ByteString.AbstractByteIterator() { // from class: androidx.datastore.preferences.protobuf.RopeByteString.1
            ...
            private ByteString.ByteIterator nextPiece() {
                if (this.pieces.hasNext()) {
                    return this.pieces.mo238next().iterator();
                }
                return null;
            }
    ...
    public List<ByteBuffer> asReadOnlyByteBufferList() {
        ...
        while (pieces.hasNext()) {
            ByteString.LeafByteString byteString = pieces.mo238next();
    ...
    public static final class PieceIterator implements Iterator<ByteString.LeafByteString> {
        ...
        @Override // java.util.Iterator
        /* renamed from: next */
        public ByteString.LeafByteString mo238next() {
            if (this.next == null) {
                throw new NoSuchElementException();
            }
    ...
    private class RopeInputStream extends InputStream {
        ...
        private void initialize() {
            ...
            this.currentPiece = this.pieceIterator.mo238next();
