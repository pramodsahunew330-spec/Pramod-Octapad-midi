...
public class LazyFieldLite {
    ...
    public boolean equals(Object o) {
        ...
        if (value1 != null) {
            return value1.equals(other.getValue(value1.mo214getDefaultInstanceForType()));
        }
        return getValue(value2.mo214getDefaultInstanceForType()).equals(value2);
    }
    ...
    public void merge(LazyFieldLite other) {
        ...
        if (this.delayedBytes != null && other.delayedBytes != null) {
            ...
            setValue(this.value.mo208toBuilder().mo146mergeFrom(other.value).mo209build());
        }
    }
    ...
    public void mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        ...
        try {
            setValue(this.value.mo208toBuilder().mo215mergeFrom(input, extensionRegistry).mo209build());
    ...
    private static MessageLite mergeValueAndBytes(MessageLite value, ByteString otherBytes, ExtensionRegistryLite extensionRegistry) {
        try {
            return value.mo208toBuilder().mo143mergeFrom(otherBytes, extensionRegistry).mo209build();
        } catch (InvalidProtocolBufferException e) {
            return value;
        }
    }
    ...
    protected void ensureInitialized(MessageLite defaultInstance) {
        ...
        synchronized (this) {
            ...
            try {
                if (this.delayedBytes != null) {
                    MessageLite parsedValue = defaultInstance.getParserForType().mo156parseFrom(this.delayedBytes, this.extensionRegistry);
