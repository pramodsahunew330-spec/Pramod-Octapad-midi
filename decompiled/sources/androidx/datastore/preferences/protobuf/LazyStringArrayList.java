...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public LazyStringArrayList mo237mutableCopyWithCapacity(int capacity) {
        if (capacity < size()) {
    ...
    public String mo235remove(int index) {
        ensureIsMutable();
    ...
    private static class ByteArrayListView extends AbstractList<byte[]> implements RandomAccess {
        ...
        public byte[] remove(int index) {
            Object o = this.list.mo235remove(index);
            this.modCount++;
            return LazyStringArrayList.asByteArray(o);
        }
    }
    ...
    private static class ByteStringListView extends AbstractList<ByteString> implements RandomAccess {
        ...
        @Override // java.util.AbstractList, java.util.List
        /* renamed from: get */
        public ByteString mo231get(int index) {
        ...
        @Override // java.util.AbstractList, java.util.List
        /* renamed from: remove */
        public ByteString mo232remove(int index) {
            Object o = this.list.mo235remove(index);
            this.modCount++;
            return LazyStringArrayList.asByteString(o);
        }
