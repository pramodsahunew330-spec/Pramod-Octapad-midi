...
public abstract class Transition implements Cloneable {
    ...
    public Transition mo328setDuration(long duration) {
    ...
    public Transition mo331setStartDelay(long startDelay) {
    ...
    public Transition mo329setInterpolator(TimeInterpolator interpolator) {
    ...
    public Transition mo319addTarget(View target) {
        this.mTargets.add(target);
        return this;
    }

    /* renamed from: addTarget */
    public Transition mo318addTarget(int targetId) {
        if (targetId != 0) {
    ...
    /* renamed from: addTarget */
    public Transition mo321addTarget(String targetName) {
    ...
    /* renamed from: addTarget */
    public Transition mo320addTarget(Class<?> targetType) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo325removeTarget(View target) {
        this.mTargets.remove(target);
        return this;
    }

    /* renamed from: removeTarget */
    public Transition mo324removeTarget(int targetId) {
        if (targetId != 0) {
    ...
    /* renamed from: removeTarget */
    public Transition mo327removeTarget(String targetName) {
        if (this.mTargetNames != null) {
    ...
    /* renamed from: removeTarget */
    public Transition mo326removeTarget(Class<?> target) {
        if (this.mTargetTypes != null) {
    ...
    public Transition mo317addListener(TransitionListener listener) {
    ...
    public Transition mo323removeListener(TransitionListener listener) {
        if (this.mListeners == null) {
            return this;
        }
    ...
    public Transition mo330setSceneRoot(ViewGroup sceneRoot) {
