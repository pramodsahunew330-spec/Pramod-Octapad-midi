...
public class TransitionSet extends Transition {
    ...
    public /* bridge */ /* synthetic */ Transition mo320addTarget(Class cls) {
        return mo320addTarget((Class<?>) cls);
    }

    @Override // androidx.transition.Transition
    /* renamed from: removeTarget */
    public /* bridge */ /* synthetic */ Transition mo326removeTarget(Class cls) {
        return mo326removeTarget((Class<?>) cls);
    }
    ...
    public TransitionSet addTransition(Transition transition) {
        ...
        if (this.mDuration >= 0) {
            transition.mo328setDuration(this.mDuration);
        }
        if ((this.mChangeFlags & 1) != 0) {
            transition.mo329setInterpolator(getInterpolator());
        }
    ...
    public TransitionSet mo328setDuration(long duration) {
        super.mo328setDuration(duration);
        if (this.mDuration >= 0 && this.mTransitions != null) {
            int numTransitions = this.mTransitions.size();
            for (int i = 0; i < numTransitions; i++) {
                this.mTransitions.get(i).mo328setDuration(duration);
            }
        }
        return this;
    }
    ...
    public TransitionSet mo331setStartDelay(long startDelay) {
        return (TransitionSet) super.mo331setStartDelay(startDelay);
    }

    @Override // androidx.transition.Transition
    /* renamed from: setInterpolator  reason: collision with other method in class */
    public TransitionSet mo329setInterpolator(TimeInterpolator interpolator) {
        this.mChangeFlags |= 1;
        if (this.mTransitions != null) {
            int numTransitions = this.mTransitions.size();
            for (int i = 0; i < numTransitions; i++) {
                this.mTransitions.get(i).mo329setInterpolator(interpolator);
            }
        }
        return (TransitionSet) super.mo329setInterpolator(interpolator);
    }

    @Override // androidx.transition.Transition
    /* renamed from: addTarget  reason: collision with other method in class */
    public TransitionSet mo319addTarget(View target) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo319addTarget(target);
        }
        return (TransitionSet) super.mo319addTarget(target);
    }

    @Override // androidx.transition.Transition
    /* renamed from: addTarget  reason: collision with other method in class */
    public TransitionSet mo318addTarget(int targetId) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo318addTarget(targetId);
        }
        return (TransitionSet) super.mo318addTarget(targetId);
    }

    @Override // androidx.transition.Transition
    /* renamed from: addTarget  reason: collision with other method in class */
    public TransitionSet mo321addTarget(String targetName) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo321addTarget(targetName);
        }
        return (TransitionSet) super.mo321addTarget(targetName);
    }

    @Override // androidx.transition.Transition
    /* renamed from: addTarget  reason: collision with other method in class */
    public TransitionSet mo320addTarget(Class<?> targetType) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo320addTarget(targetType);
        }
        return (TransitionSet) super.mo320addTarget(targetType);
    }

    @Override // androidx.transition.Transition
    /* renamed from: addListener  reason: collision with other method in class */
    public TransitionSet mo317addListener(Transition.TransitionListener listener) {
        return (TransitionSet) super.mo317addListener(listener);
    }

    @Override // androidx.transition.Transition
    /* renamed from: removeTarget  reason: collision with other method in class */
    public TransitionSet mo324removeTarget(int targetId) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo324removeTarget(targetId);
        }
        return (TransitionSet) super.mo324removeTarget(targetId);
    }

    @Override // androidx.transition.Transition
    /* renamed from: removeTarget  reason: collision with other method in class */
    public TransitionSet mo325removeTarget(View target) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo325removeTarget(target);
        }
        return (TransitionSet) super.mo325removeTarget(target);
    }

    @Override // androidx.transition.Transition
    /* renamed from: removeTarget  reason: collision with other method in class */
    public TransitionSet mo326removeTarget(Class<?> target) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo326removeTarget(target);
        }
        return (TransitionSet) super.mo326removeTarget(target);
    }

    @Override // androidx.transition.Transition
    /* renamed from: removeTarget  reason: collision with other method in class */
    public TransitionSet mo327removeTarget(String target) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).mo327removeTarget(target);
        }
        return (TransitionSet) super.mo327removeTarget(target);
    }
    ...
    public TransitionSet mo323removeListener(Transition.TransitionListener listener) {
        return (TransitionSet) super.mo323removeListener(listener);
    }
    ...
    private void setupStartEndListeners() {
        ...
        while (it.hasNext()) {
            ...
            childTransition.mo317addListener(listener);
        }
    ...
    public static class TransitionSetListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            transition.mo323removeListener(this);
        }
    }
        ...
        for (int i = 0; i < numTransitions; i++) {
            ...
            if (startDelay > 0 && (this.mPlayTogether || i == 0)) {
                ...
                if (childStartDelay > 0) {
                    childTransition.mo331setStartDelay(startDelay + childStartDelay);
                } else {
                    childTransition.mo331setStartDelay(startDelay);
                }
            }
    ...
    public void runAnimators() {
        ...
        if (!this.mPlayTogether) {
            for (int i = 1; i < this.mTransitions.size(); i++) {
                ...
                previousTransition.mo317addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionSet.1
                    @Override // androidx.transition.TransitionListenerAdapter, androidx.transition.Transition.TransitionListener
                    public void onTransitionEnd(Transition transition) {
    ...
    public TransitionSet mo330setSceneRoot(ViewGroup sceneRoot) {
        super.mo330setSceneRoot(sceneRoot);
        int numTransitions = this.mTransitions.size();
        for (int i = 0; i < numTransitions; i++) {
            this.mTransitions.get(i).mo330setSceneRoot(sceneRoot);
        }
        return this;
    }
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo322clone() {
        TransitionSet clone = (TransitionSet) super.m316clone();
        clone.mTransitions = new ArrayList<>();
        int numTransitions = this.mTransitions.size();
        for (int i = 0; i < numTransitions; i++) {
            clone.addTransitionInternal(this.mTransitions.get(i).m316clone());
        }
        return clone;
    }
}
