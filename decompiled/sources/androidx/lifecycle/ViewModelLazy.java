...
public final class ViewModelLazy<VM extends ViewModel> implements Lazy<VM> {
    ...
    public /* synthetic */ ViewModelLazy(KClass kClass, Function0 function0, Function0 function02, AnonymousClass1 anonymousClass1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(kClass, function0, function02, (i & 8) != 0 ? AnonymousClass1.INSTANCE : anonymousClass1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: ViewModelLazy.kt */
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "Landroidx/lifecycle/viewmodel/CreationExtras$Empty;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<CreationExtras.Empty> {
        ...
        /* renamed from: invoke */
        public final CreationExtras.Empty mo2400invoke() {
    ...
    public VM mo300getValue() {
        VM vm = this.cached;
        if (vm == null) {
            ViewModelProvider.Factory factory = this.factoryProducer.mo2400invoke();
            ViewModelStore store = this.storeProducer.mo2400invoke();
            VM vm2 = (VM) new ViewModelProvider(store, factory, this.extrasProducer.mo2400invoke()).get(JvmClassMappingKt.getJavaClass((KClass) this.viewModelClass));
            this.cached = vm2;
            return vm2;
        }
        return vm;
