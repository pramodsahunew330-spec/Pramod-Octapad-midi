...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        MainCoroutineDispatcher $this$dispatchAndEnqueue_u24lambda_u242 = Dispatchers.getMain().mo2256getImmediate();
        if ($this$dispatchAndEnqueue_u24lambda_u242.isDispatchNeeded(context) || canRun()) {
            $this$dispatchAndEnqueue_u24lambda_u242.mo2336dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
