...
public class FragmentStore {
            ...
            if (fragmentStateManager2 != null) {
                ...
                if (beingRemoved) {
                    if (f.mBeingSaved && !this.mSavedState.containsKey(f.mWho)) {
                        setSavedState(f.mWho, fragmentStateManager2.saveState());
                    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Bundle getSavedState(String who) {
        return this.mSavedState.get(who);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Bundle setSavedState(String who, Bundle bundle) {
        if (bundle != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void restoreSaveState(HashMap<String, Bundle> allSavedStates) {
