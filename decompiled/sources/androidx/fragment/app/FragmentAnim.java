    ...
    private static int transitToAnimResourceId(Context context, int transit, boolean enter) {
        ...
        switch (transit) {
            ...
            case FragmentTransaction.TRANSIT_FRAGMENT_MATCH_ACTIVITY_OPEN /* 4100 */:
                if (enter) {
                    activityTransitResId = toActivityTransitResId(context, 16842936);
                } else {
                    activityTransitResId = toActivityTransitResId(context, 16842937);
                }
            ...
            case FragmentTransaction.TRANSIT_FRAGMENT_MATCH_ACTIVITY_CLOSE /* 8197 */:
                if (enter) {
                    activityTransitResId2 = toActivityTransitResId(context, 16842938);
                } else {
                    activityTransitResId2 = toActivityTransitResId(context, 16842939);
                }
