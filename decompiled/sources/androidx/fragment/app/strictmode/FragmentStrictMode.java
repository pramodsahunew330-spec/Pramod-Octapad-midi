...
public final class FragmentStrictMode {
    ...
    public static final void onWrongNestedHierarchy(Fragment fragment, Fragment expectedParentFragment, int containerId) {
        ...
        Violation violation = new WrongNestedHierarchyViolation(fragment, expectedParentFragment, containerId);
        INSTANCE.logIfDebuggingEnabled(violation);
        Policy policy = INSTANCE.getNearestPolicy(fragment);
        if (policy.getFlags$fragment_release().contains(Flag.DETECT_WRONG_NESTED_HIERARCHY) && INSTANCE.shouldHandlePolicyViolation(policy, fragment.getClass(), violation.getClass())) {
            INSTANCE.handlePolicyViolation(policy, violation);
        }
    }
    ...
    private final boolean shouldHandlePolicyViolation(Policy policy, Class<? extends Fragment> cls, Class<? extends Violation> cls2) {
        String fragmentClassString = cls.getName();
        Set violationsToBypass = policy.getMAllowedViolations$fragment_release().get(fragmentClassString);
        if (violationsToBypass == null) {
            return true;
        }
        if (!Intrinsics.areEqual(cls2.getSuperclass(), Violation.class) && CollectionsKt.contains(violationsToBypass, cls2.getSuperclass())) {
            return false;
        }
        return true ^ violationsToBypass.contains(cls2);
    }
    ...
    private final void handlePolicyViolation(final Policy policy, final Violation violation) {
        ...
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new Runnable() { // from class: androidx.fragment.app.strictmode.FragmentStrictMode$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentStrictMode.handlePolicyViolation$lambda$1(fragmentName, violation);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void handlePolicyViolation$lambda$1(String $fragmentName, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
    ...
    public static final class Policy {
        ...
        /* compiled from: FragmentStrictMode.kt */
        @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Landroidx/fragment/app/strictmode/FragmentStrictMode$Policy$Companion;", "", "()V", "LAX", "Landroidx/fragment/app/strictmode/FragmentStrictMode$Policy;", "fragment_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        /* loaded from: classes.dex */
