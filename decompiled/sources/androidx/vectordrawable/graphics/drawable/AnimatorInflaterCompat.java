            ...
            if (getFloats) {
                ...
                if (hasTo) {
                    if (toType3 == 5) {
                        ...
                        valueTo2 = isColorType(toType3) ? styledAttributes.getColor(valueToId, 0) : styledAttributes.getInt(valueToId, 0);
                    }
                ...
                if (toType3 == 5) {
                    ...
                    valueTo = isColorType(toType3) ? styledAttributes.getColor(valueToId, 0) : styledAttributes.getInt(valueToId, 0);
                }
